...
public class MocTeamConfigmstNew {

	private  Object [] saveArray = null; 
	private MocRfcmstNew mocRfcmst;
...
public String getMctcTempfield4() {
	...
	// adding alias for tempfield10 Vignesh 13 may
	
	public String getMctcSecEmpid() {
	    return (String) saveArray[tableFldConstants.tempfield10.ordinal()];
	}

	public void setMctcSecEmpid(String secEmpid) {
	    saveArray[tableFldConstants.tempfield10.ordinal()] = secEmpid;
	}
	// adding alias for tempfield10 Vignesh 13 may
	...
	public void setMctcRfcmst(MocRfcmstNew mocRfcmst) {
		this.mocRfcmst = mocRfcmst;
	}

	public MocRfcmstNew getMctcRfcmst() {
		return mocRfcmst;
	}
