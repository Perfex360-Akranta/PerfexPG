...
public class BdmTlYyeffectivedtl {
	...
	public static String toJsonManualList(List<BdmTlYyeffectivedtl> list) {
	...
	public static List<BdmTlYyeffectivedtl> fromJsonList(String json) {
	    List<BdmTlYyeffectivedtl> list = new ArrayList<>();
	...
	public static BdmTlYyeffectivedtl fromJson(String json) {
	    JSONObject obj = JSONObject.fromObject(json);
	    BdmTlYyeffectivedtl dtl = new BdmTlYyeffectivedtl();
	    for (tableFldConstants field : tableFldConstants.values()) {
