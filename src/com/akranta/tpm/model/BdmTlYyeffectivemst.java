...
public class BdmTlYyeffectivemst {
	...
	public BdmTlYyeffectivemst()
	{
		saveArray = new  Object [ 17 ];
	}

	private List<BdmTlYyeffectivedtl> bdmTlYyeffectivedtl ;
	private List<BdmTlYyeffectivemst> bdmTlYyeffectivemst ;
	...
	public List<BdmTlYyeffectivemst> getBdmTlYyeffectivemst() {
		return bdmTlYyeffectivemst;
	}

	public void setBdmTlYyeffectivemst(List<BdmTlYyeffectivemst> bdmTlYyeffectivemst) {
	...
	public static BdmTlYyeffectivemst fromJson(String json) {
	    JSONObject obj = JSONObject.fromObject(json);
	    BdmTlYyeffectivemst mst = new BdmTlYyeffectivemst();
	    for (tableFldConstants field : tableFldConstants.values()) {
	...
	public static String toJsonManualList(List<BdmTlYyeffectivemst> list) {
