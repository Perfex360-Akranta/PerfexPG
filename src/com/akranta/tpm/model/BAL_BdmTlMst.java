...
public class BAL_BdmTlMst {
	...
	private  WomTlWomst womTlWomst ;
	private List<BAL_BdmTlDtl> bdmDetail ;
	private List<BAL_PcsTlPcsBd> pcsbd ;
	private List<BAL_BdmTlShiftwisesplit> bdmShiftwise;
	private List<BAL_BdmTlMultipleResp> bdmMultiResp;
	private String externalserviceId;
	private String bdmsRepeatedbdWhWhyNo;
	private String chkCompletedBy;
	private String chkOtherPhenomena;
	...
	public BAL_BdmTlMst()
	{
		setBdmDetail(new ArrayList<BAL_BdmTlDtl> ());
		setPcsbd(new ArrayList<BAL_PcsTlPcsBd>());
		setBdmShiftwise(new ArrayList<BAL_BdmTlShiftwisesplit> ());
	...
	public String getBdmsCompleteddate() {
		return (String) saveArray[ tableFldConstants.completeddate.ordinal() ];
	}

	public void setBdmsCompleteddate(String bdmsCompleteddate) {
		saveArray[ tableFldConstants.completeddate.ordinal() ] = bdmsCompleteddate;
	}

	public String getBdmsProblemreason() {
		return (String) saveArray[ tableFldConstants.problemreason.ordinal() ];
	}

	public void setBdmsProblemreason(String bdmsProblemreason) {
		saveArray[ tableFldConstants.problemreason.ordinal() ] = bdmsProblemreason;
	}

	public String getBdmsActivity() {
		return (String) saveArray[ tableFldConstants.activity.ordinal() ];
	}

	public void setBdmsActivity(String bdmsActivity) {
		saveArray[ tableFldConstants.activity.ordinal() ] = bdmsActivity;
	}

	public String getBdmsOtherPhenomena() {
		return (String) saveArray[ tableFldConstants.otherphenomena.ordinal() ];
	}

	public void setBdmsOtherPhenomena(String bdmsotherphenomena) {
		saveArray[ tableFldConstants.otherphenomena.ordinal() ] = bdmsotherphenomena;
	}
	...
	public List<BAL_BdmTlDtl> getBdmDetail() {
		return bdmDetail;
	}

	public void setBdmDetail(List<BAL_BdmTlDtl> bdmDetail) {
		this.bdmDetail = bdmDetail;
	}
	private void setPcsbd(List<BAL_PcsTlPcsBd> pcsbd) {
		this.pcsbd=pcsbd;
		// TODO Auto-generated method stub
		
	}
	public List<BAL_PcsTlPcsBd> getPcsbd(){
		return pcsbd;
	}


	public List<BAL_BdmTlShiftwisesplit> getBdmShiftwise() {
		return bdmShiftwise;
	}

	public void setBdmShiftwise(List<BAL_BdmTlShiftwisesplit> bdmShiftwise) {
		this.bdmShiftwise = bdmShiftwise;
	}

	public List<BAL_BdmTlMultipleResp> getbdmTlMultipleResp() {
		return bdmMultiResp;
	}

	public void setbdmTlMultipleResp(List<BAL_BdmTlMultipleResp> bdmMultiResp) {
	...
	public void setBdmsRepeatedbdWhWhyNo(String bdmsRepeatedbdWhWhyNo) {
		this.bdmsRepeatedbdWhWhyNo = bdmsRepeatedbdWhWhyNo;
	}

	public String getBdmsRepeatedbdWhWhyNo() {
		return bdmsRepeatedbdWhWhyNo;
	}

	public void setWomTlWomst(WomTlWomst womTlWomst) {
		this.womTlWomst = womTlWomst;
	}

	public WomTlWomst getWomTlWomst() {
		return womTlWomst;
	}
	...
	public void setchkOtherPhenomena(String othrphenomena) {
		this.chkOtherPhenomena = othrphenomena;
	}

	public String getchkOtherPhenomena() {
		return chkOtherPhenomena;
	}	
    ...
    /**
     * Deserialises a JSON string (Spring response "master" object) back into a
     * BAL_BdmTlMst instance.
     */
    public static BAL_BdmTlMst fromJson(String json) {
        net.sf.json.JSONObject obj = net.sf.json.JSONObject.fromObject(json);
        BAL_BdmTlMst mst = new BAL_BdmTlMst();
        for (tableFldConstants field : tableFldConstants.values()) {
            ...
            mst.saveArray[field.ordinal()] = val;
        }
        return mst;
    }
