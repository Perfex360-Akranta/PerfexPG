...
public class PlmTlConditionalappraisalmstentry {
	...
	private PlmTlConditionalappraisalEntry plmTlConditionalappraisal ;
	...
	public PlmTlConditionalappraisalmstentry()
	{
	...
	public void setPlmTlConditionalappraisal(PlmTlConditionalappraisalEntry plmTlConditionalappraisal) {
		this.plmTlConditionalappraisal = plmTlConditionalappraisal;
	}

	public PlmTlConditionalappraisalEntry getPlmTlConditionalappraisal() {
	...
	/**
	 * Convert master entry object to JSON string
	 */
	...
	/**
	 * Parse JSON string to master entry object
	 */
	public static PlmTlConditionalappraisalmstentry fromJson(String json) {
		CommonMessage.debugMsg("RAW JSON Response: [" + json + "]");

		JSONObject obj = JSONObject.fromObject(json);

		PlmTlConditionalappraisalmstentry mstEntry = new PlmTlConditionalappraisalmstentry();
		CommonMessage.debugMsg("RAW JSON Response: :" + json);
		...
		for (tableFldConstants field : tableFldConstants.values()) {
			...
			mstEntry.setValue(field, val != null && val.equals("null") ? null : val);
		}
		return mstEntry;
	}
}
