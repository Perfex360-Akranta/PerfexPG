...
public class GenTlMachinemst {
	...
	public enum   tableFldConstants
	{
		...
		, tradeid,tempfield3 ,tempfield4 ,tempfield5, elementid, flid
		, active, createdby, createdon, modifiedon
	}

	public GenTlMachinemst()
	{
	...
	public String getMchmTempfield3() {
		return (String) saveArray[ tableFldConstants.tempfield3.ordinal() ];
	}

	public void setMchmTempfield3(String mchmtempfield3) {
		saveArray[ tableFldConstants.tempfield3.ordinal() ] = mchmtempfield3;
	}
    ...
    /**
     * Parse a single machine master from JSON string
     */
    public static GenTlMachinemst fromJson(String json) {
        CommonMessage.debugMsg("RAW JSON Response: [" + json + "]");

        JSONObject obj = JSONObject.fromObject(json);
        GenTlMachinemst machine = new GenTlMachinemst();
    ...
    /**
     * Parse a list of machine masters from JSON array string
     */
    public static List<GenTlMachinemst> fromJsonList(String json) {
        CommonMessage.debugMsg("RAW JSON ARRAY Response: " + json);

        JSONArray jsonArray = JSONArray.fromObject(json);
        List<GenTlMachinemst> list = new ArrayList<>();
    ...
    /**
     * Convert a list of machine masters to JSON array string
     */
    public static String toJsonManualList(List<GenTlMachinemst> list) {
        StringBuilder sb = new StringBuilder();
        sb.append("[");
