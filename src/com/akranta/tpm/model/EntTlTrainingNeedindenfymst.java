...
public class EntTlTrainingNeedindenfymst {
	...
	public EntTlTrainingNeedindenfymst()
	{
	...
	public String getTnimUniqueid() {
		return (String) saveArray[ tableFldConstants.uniqueid.ordinal() ];
	}

	public void setTnimUniqueid(String tnimUniqueid) {
		saveArray[ tableFldConstants.uniqueid.ordinal() ] = tnimUniqueid;
	}
	...
	public String getTnimTempfield1() {
		return (String) saveArray[ tableFldConstants.tempfield1.ordinal() ];
	}

	public void setTnimTempfield1(String tnimTempfield1) {
		saveArray[ tableFldConstants.tempfield1.ordinal() ] = tnimTempfield1;
	}
