...
public class EntTlUniqpostopicLinkmst {

	private  Object [] saveArray = null;  
	private List<EntTlUniqpostopicLinkdtl> TaskTopicDetails;
	private String tmtmElementType;
	...
	public EntTlUniqpostopicLinkmst()
	{
		setTaskTopicDetails(new ArrayList<EntTlUniqpostopicLinkdtl> ());
	...
	public String getTmtmElementId() {
		return (String) saveArray[ tableFldConstants.elementid.ordinal() ];
	}

	public void setTmtmElementId(String tmtmElementId) {
		saveArray[ tableFldConstants.elementid.ordinal() ] = tmtmElementId;
	}
	...
	public void setTaskTopicDetails(List<EntTlUniqpostopicLinkdtl> taskGridList1) {
		this.TaskTopicDetails = taskGridList1;
		
	}

	public List<EntTlUniqpostopicLinkdtl> getTaskTopicDetails() {
	...
	public String getTmtmElementType() {
		return tmtmElementType;
	}


	public void setTmtmElementType(String tmtmElementType) {
		this.tmtmElementType = tmtmElementType;
	}
