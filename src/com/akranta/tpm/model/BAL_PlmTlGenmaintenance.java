...
import com.akranta.tpm.model.BdmTlCriticalityassessment.tableFldConstants;
import com.akranta.tpm.utils.CommonMessage;

import net.sf.json.JSONArray;
import net.sf.json.JSONObject;

public class BAL_PlmTlGenmaintenance {

	private  Object [] saveArray = null;  
	private List<BAL_BdmTlSetupadjsplit> bdmTlSetupadjsplit;
	...
	public enum   tableFldConstants
	{
		 keyid, occureddate, shiftdate, bookeddate, receiveddate, allocateddate
		    ...
		    , relatedto, mouldid
		    , ordertype, errppostStatus, errppostNo, isSpares       
	...
	public List<BAL_BdmTlSetupadjsplit> getBdmTlSetupadjsplit() {
		return bdmTlSetupadjsplit;
	}

	public void setBdmTlSetupadjsplit(List<BAL_BdmTlSetupadjsplit> bdmTlSetupadjsplit) {
		this.bdmTlSetupadjsplit = bdmTlSetupadjsplit;
	}
	...
	public String getGmntOrderType() {
		return (String) saveArray[ tableFldConstants.ordertype.ordinal() ];
	}

	public void setGmntOrderType(String gmntOrdertype) {
		saveArray[ tableFldConstants.ordertype.ordinal() ] = gmntOrdertype;
	}

	public String getErrppostNo() {
		return (String) saveArray[ tableFldConstants.errppostNo.ordinal() ];
	}

	public void setErrppostNo(String txtErrpostNo) {
		saveArray[ tableFldConstants.errppostNo.ordinal() ] = txtErrpostNo;
	}

	public String getErrppostStatus() {
		return (String) saveArray[ tableFldConstants.errppostStatus.ordinal() ];
	}

	public void setErrppostStatus(String txtErrppostStatus) {
		saveArray[ tableFldConstants.errppostStatus.ordinal() ] = txtErrppostStatus;
	}

	public String getIsSpares() {
		return (String) saveArray[ tableFldConstants.isSpares.ordinal() ];
	}

	public void setIsSpares(String isSpares) {
		saveArray[ tableFldConstants.isSpares.ordinal() ] = isSpares;
	}
	...
	public void setValue(tableFldConstants field, String val) {
	...
	public static String toJsonManualList(List<BAL_PlmTlGenmaintenance> list) {
	    StringBuilder sb = new StringBuilder();
	    sb.append("[");
