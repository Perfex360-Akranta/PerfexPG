...
public class PlmTlConditionalappraisal {
	...
	public PlmTlConditionalappraisal()
	{
	 ...
	 */
	public static PlmTlConditionalappraisal fromJson(String json) {
		CommonMessage.debugMsg("RAW JSON Response: [" + json + "]");

		JSONObject obj = JSONObject.fromObject(json);

		PlmTlConditionalappraisal dtl = new PlmTlConditionalappraisal();
		CommonMessage.debugMsg("RAW JSON Response: :" + json);
	 ...
	 */
	public static List<PlmTlConditionalappraisal> fromJsonList(String json) {
		CommonMessage.debugMsg("RAW JSON ARRAY Response: " + json);

		JSONArray jsonArray = JSONArray.fromObject(json);
		List<PlmTlConditionalappraisal> list = new ArrayList<>();
	 ...
	 */
	public static String toJsonManualList(List<PlmTlConditionalappraisal> list) {
		StringBuilder sb = new StringBuilder();
		sb.append("[");
