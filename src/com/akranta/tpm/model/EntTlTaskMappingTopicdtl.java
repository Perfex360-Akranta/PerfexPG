...
public class EntTlTaskMappingTopicdtl {
	...
	public EntTlTaskMappingTopicdtl()
	{
	...
	public void setTmtdTmkmKeyid(String tmtdTmkmKeyid) {
		saveArray[ tableFldConstants.tmkm_keyid.ordinal() ] = tmtdTmkmKeyid;
	}
