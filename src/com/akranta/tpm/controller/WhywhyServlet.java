...
public class WhywhyServlet extends HttpServlet {
	...
	WhyWhyAnalysisService  whywhyService; 
	public WhywhyServlet()
	{
		/*try {
	...
	private void process(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		try {
			whywhyService = (WhyWhyAnalysisServiceImpl)UIUtils.getServiceObject(request,"WhyWhyAnalysisServiceImpl");
		} catch (ServiceObjectCreationException e) {
			com.akranta.tpm.utils.CommonMessage.debugMsg(e);
		}
	...
	private CommonFilter getFilterValues(HttpServletRequest request)
	{
		...
		CommonMessage.debugMsg("Inside the Filter values");
	...
	{
		BdmTlWhywhymst kznTlWhywhymst = fillWhyWhymst(request); 
	...
	private BdmTlWhywhymst fillWhyWhymst(HttpServletRequest request)
	{
