...
import com.akranta.tpm.service.impl.BAL_CltiScheduleServiceImpl;
...
public class BAL_ClitScheduleServlet extends HttpServlet {
	...
	BAL_CltiScheduleService cltiScheduleService;
	 CommonFilterService commonFilterService;
     public BAL_ClitScheduleServlet() throws Exception {
        super();
...
//				jhclitCalendarBean       =  new JhclitCalendarBean();
	...
	private void process(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		try {
			cltiScheduleService =  (BAL_CltiScheduleServiceImpl)UIUtils.getServiceObject(request,"BAL_CltiScheduleServiceImpl");
		...
		String dispatchUrl =null;
		 ...
		 else if(action.equals("clitCalendar_input.clitcal")) 
		{
		...
		else if(action.equals("clitCalendar_getCol.clitcal"))
		{
		...
		else if(action.equals("clitCalendar_getData.clitcal"))
		...
		else if(action.equals("employee_mail_input.clitcal")){
            String sectionId= request.getParameter("sectionId");
		...
		else if(action.equals("employee_mail_getCol.clitcal")){					
		...
		//kaizen_Mail_save.kaizen
			else if(action.equals("employee_mail_getData.clitcal")){					
				try
				{
			...
			else if(  action.contains("email_send.clitcal")){
		 ...
		 /*
		 else if(action.equals("clitCompliance_input.clitcal")) 
			{
			...
			else if(action.equals("clitCompliance_getCol.clitcal"))
			{
				System.out.println("inside getcol");
				 CommonFilter commonFilter = populateCommonFilter(request,"clitCalendarCommonFilter",true);
			...
			else if(action.equals("clitCompliance_getData.clitcal"))
				
			{ CommonFunctions.debugMsg("clitcompliance_input.clitcal In side the getdata Method");
							try
					{
						PrintWriter out = response.getWriter();
						System.out.println("inside get Data");
		 ...
		 //////////////////////////////////////////////////////////report//////////////////////
			...
			else if( action.equals("clitCompliance_getExcel.clitcal"))
			{		
...
else if( action.equals("jhcalendar_getExcel.clitcal")||action.equals("jhplancreation_getExcel.clitcal")){
...
else if( action.equals("cmb_shift.clitcal"))
{
	try {					
		...
		e.printStackTrace();
			...
			else if( action.equals("clitCalendar_save.clitcal"))
			{	
