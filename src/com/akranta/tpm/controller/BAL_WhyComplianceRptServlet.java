...
import com.akranta.tpm.service.BAL_WhyComplianceRptService;

import com.akranta.tpm.service.impl.BAL_BreakdownServiceImpl;
import com.akranta.tpm.service.impl.BAL_WhyComplianceRptServiceImpl;
...
public class BAL_WhyComplianceRptServlet extends HttpServlet {
	...
	BAL_WhyComplianceRptService whyComplianceRptService ;
	
	
	public BAL_WhyComplianceRptServlet(){
	/*	try {
	...
	*/	
	...
	private void process(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		try {
			whyComplianceRptService = (BAL_WhyComplianceRptServiceImpl)UIUtils.getServiceObject(request,"WhyComplianceRptServiceImpl");
		...
		else if(action.equals("WhyComplianceRpt_getCol.yyComRpt"))
		{
			...
			CommonFunctions.debugMsg("2222222222  :" +fromDetail +"colIndex  ++"+colIndex);
		...
		else if( action.equals("WhyComplianceRpt_getData.yyComRpt") )
		{
			...
			CommonFunctions.debugMsg(commonFilter + " flag " + commonFilter.getDrillFlag());
			if( (commonFilter.getDrillFlag() == DrillLevelConstants.forwardFlag || commonFilter.getDrillFlag() == DrillLevelConstants.backwardFlag) || (fromDetail != null  &&   ! fromDetail.equals("Y") )) {
