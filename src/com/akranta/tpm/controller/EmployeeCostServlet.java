...
public class EmployeeCostServlet  extends HttpServlet  {
	...
	public EmployeeCostServlet() throws Exception
	{
		//Constructor
	...
	private void process(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
	{
		...
		{ 	
			CommonMessage.debugMsg("inside getcol.d...");
			
			PrintWriter out = response.getWriter();
			String type = request.getParameter("type");
			
			if (type.equals("Employee"))	{
				CommonMessage.debugMsg(UIUtils.getPropertyValue("com.akranta.tpm.resources.EmployeeCostColModel", "employeeCost"));
				out.println(UIUtils.getPropertyValue("com.akranta.tpm.resources.EmployeeCostColModel", "employeeCost"));			
			}
			else if (type.equals("Utility"))	{
				CommonMessage.debugMsg(UIUtils.getPropertyValue("com.akranta.tpm.resources.EmployeeCostColModel", "utilityCost"));
				...
				CommonMessage.debugMsg(UIUtils.getPropertyValue("com.akranta.tpm.resources.EmployeeCostColModel", "contractorCost"));
		...
		{		
			try
			{	
				CommonMessage.debugMsg("inside getdata ss...");
				
				CommonMessage.debugMsg(request.getParameter("type"));
				...
				CommonMessage.debugMsg(employeeCostList.size());
		...
		{				
			try {
				CommonMessage.debugMsg("inside comb get empl");
				String deptId = request.getParameter("deptId"); 
				String desId = request.getParameter("desId");
				CommonMessage.debugMsg("dept"+deptId);
				CommonMessage.debugMsg("des"+desId);
				String condSql ="";
		...
		{			
			CommonMessage.debugMsg("inside empo");
...
private void saveEmployeeCost(HttpServletRequest request, HttpServletResponse response ) throws IOException
{
	...
	{   
		...
		CommonMessage.debugMsg("empm"+request.getParameter("empmId"));
		CommonMessage.debugMsg("normalcost"+request.getParameter("normalCost"));
		...
		CommonMessage.debugMsg("formBean Mode"+employeeCostBean.getFormActionMode());
		...
		try{
			...
			if (type.equals("Employee") || type.equals("Utility")) {
				...
				CommonMessage.debugMsg(request.getParameter("cmbEmpcManpoweridcc"));
				...
				CommonMessage.debugMsg(newGenTlEmployeecost.getEmpcOtcostperhour());
			...
			{
				CommonMessage.debugMsg(" inside contractor cost sdjkdkdf");	
				...
				CommonMessage.debugMsg(newWomTlContractormst.getCncsOtcost());
...
public static void writeEmpDetails(HttpServletResponse response,List<String[]> empDetails ) throws IOException
{
	 ...
	 PrintWriter out = response.getWriter(); 	
	 CommonMessage.debugMsg("inside write empdet");
     ...
     CommonMessage.debugMsg("completed");
