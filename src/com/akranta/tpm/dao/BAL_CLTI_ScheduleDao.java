...
public interface BAL_CLTI_ScheduleDao {
	...
	public String save(List<String> actlst, String cellId,String mchineId, String shiftId,String createdBy,String status,List<String> obsernlst,List<String> tagclasslist)throws Exception;
