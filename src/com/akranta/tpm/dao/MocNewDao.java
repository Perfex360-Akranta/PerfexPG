...
public interface MocNewDao {
	...
	MocRfcmstNew createMOC(MocRfcmstNew mocRfcmst,MocRfcBasismst mocRfcBasismst,MocTeamConfigmstNew mocTeamConfigmst) throws Exception;

	List<MocRfcBasismst> createBasis(List<MocRfcBasismst> fillValuesMOCBasis, String createdBy, MocRfcmstNew mocRfcmst) throws Exception;
	...
	List<MocTeamConfigmstNew> createTeam(List<MocTeamConfigmstNew> fillValuesMOCTeam, String createdBy, MocRfcmstNew mocRfcmst) throws Exception;

	//public List<MocRfQuestions> createQuestions(List<MocRfQuestions> fillValuesMOCQuestns) throws Exception;



	public abstract MocRfcmstNew update(MocRfcmstNew mocRfcmst,String MocId,String Nature ,String Desc,String Detail, String Dmt,String Jh,String Initiator,String MOCTitle,String MocType,String noOfDays) throws Exception;
 ...
 //Swetha - update What if method change - 22 May
 	public WhatifMst UpdateWhatif(WhatifMst newWhatifMst,String Keyid,String WhatifKeyId,List<MOCReccommendation> mOCReccommendationList,String flid,String elementId) throws BusinessApplicationExceptions,ValidationException,Exception;
 	//Swetha - update What if method change - 22 May
 	
 	
 	//Swetha - update Hazop method change - 22 May
 	public HazopMst UpdateHazop(HazopMst newHazopMst,String HazopKeyId,List<MOCReccommendation> mOCReccommendationList,String flid,String elementId) throws Exception;
 	//Swetha - update Hazop method change - 22 May
