...
public interface BAL_GenTlMachinemstDao {

	public abstract BAL_GenTlMachinemst create(BAL_GenTlMachinemst genTlMachinemst) throws Exception;
	public abstract BAL_GenTlMachinemst update(BAL_GenTlMachinemst genTlMachinemst) throws Exception;
	public abstract BAL_GenTlMachinemst delete(String delMode, BAL_GenTlMachinemst genTlMachinemst,EquipmentBean equipmentBean,FunctionalLocn functionalLocn) throws BusinessApplicationExceptions, Exception;
	public abstract BAL_GenTlMachinemst getselect(String MchmKeyid) throws Exception;
