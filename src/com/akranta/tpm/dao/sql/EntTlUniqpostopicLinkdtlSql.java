...
public class EntTlUniqpostopicLinkdtlSql {

	public static final String TBL_ENT_TL_UNIQPOSTOPIC_LINKDTL = "ENT_TL_UNIQPOSTOPIC_LINKDTL";  
	...
	public EntTlUniqpostopicLinkdtlSql()
	{
		...
		tmtdDbFields[ tableFldConstants.tmkd_keyid.ordinal() ].fieldName = "TMTD_TMKD_KEYID";
		tmtdDbFields[ tableFldConstants.tmkd_keyid.ordinal() ].fieldType = 'V';
	...
	{
		return SqlUtils.getInsertSql(TBL_ENT_TL_UNIQPOSTOPIC_LINKDTL, fieldTypeArr, dataArray);
	}

	public static String getUpdateSql(TableFieldType [] fieldTypeArr, Object [] dataArray)
	{
		String sql = SqlUtils.getUpdateSql(TBL_ENT_TL_UNIQPOSTOPIC_LINKDTL, fieldTypeArr, dataArray);
	...
	{
		String sql = "DELETE from " + TBL_ENT_TL_UNIQPOSTOPIC_LINKDTL ;
	...
	public static String DeleteTasklist(String keyid) {
		...
		String sql=" DELETE FROM " + TBL_ENT_TL_UNIQPOSTOPIC_LINKDTL + " WHERE TMTD_KEYID ='"+keyid+"'";
		CommonMessage.debugMsg("Delete Row Sql: "+sql);
		return sql;
	}
	public static String DeleteTopiclist(String keyid) {
		CommonMessage.debugMsg("Keyid 3333:::::"+keyid);
		String sql=" DELETE FROM " + TBL_ENT_TL_UNIQPOSTOPIC_LINKDTL+ " WHERE TMTD_TMKD_KEYID ='"+keyid+"'";
		CommonMessage.debugMsg("Delete Row Sql: "+sql);
		return sql;
	}
	...
	public static String getDeleteDtlSql(String tmtmKeyid) {
		...
		String sql=" DELETE FROM " + TBL_ENT_TL_UNIQPOSTOPIC_LINKDTL+ " WHERE TMTD_TMTM_KEYID ='"+tmtmKeyid+"'";
		CommonMessage.debugMsg("Delete Row Sql: "+sql);
		return sql;
	}
