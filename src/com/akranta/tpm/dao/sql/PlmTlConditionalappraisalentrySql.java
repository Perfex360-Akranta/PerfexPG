...
public class PlmTlConditionalappraisalentrySql {

	public static final String TBL_PLM_TL_CONDITIONALAPPRAISALENTRY = "PLM_TL_CONAPPRAISALENTRY";  
	...
	public PlmTlConditionalappraisalentrySql()
	{
		...
		cdapDbFields[ tableFldConstants.Cdapkeyid.ordinal() ].fieldName = "CDAP_CDAPKEYID";
		cdapDbFields[ tableFldConstants.Cdapkeyid.ordinal() ].fieldType = 'V';
	...
	{
		return SqlUtils.getInsertSql(TBL_PLM_TL_CONDITIONALAPPRAISALENTRY, fieldTypeArr, dataArray);
	}

	public static String getUpdateSql(TableFieldType [] fieldTypeArr, Object [] dataArray)
	{
		StringBuilder sql = new StringBuilder( SqlUtils.getUpdateSql(TBL_PLM_TL_CONDITIONALAPPRAISALENTRY, fieldTypeArr, dataArray));
	...
	public static String getDeleteSql(TableFieldType [] fieldTypeArr, Object [] dataArray)
	{
		...
		sql.append(TBL_PLM_TL_CONDITIONALAPPRAISALENTRY );
		sql.append( " where " );
		sql.append(fieldTypeArr[tableFldConstants.keyid.ordinal()].fieldName ); 
		sql.append( " = '" );
		sql.append((String)dataArray[ tableFldConstants.keyid.ordinal()] );
	...
	public static String selectData(String keyid) {
		...
		sql+=" CDAP_STATUS,CDAP_ACTIONREQUIRED,CDAP_REFURBISHMENT_STATUS,TO_CHAR (CDAP_CREATEDON, 'DD-MON-YYYY') FROM PLM_TL_CONAPPRAISALENTRY ";
		sql+=" WHERE CDAP_KEYID = '"+keyid+"'";
		CommonMessage.debugMsg("selectData...."+sql);
		return sql;
	}
	public static String getSingledata() {
		String sql = "SELECT * FROM  PLM_TL_CONAPPRAISALMSTENTRY WHERE CDAM_KEYID = ? " ;
		return sql;
	}
}
