...
/*	public static String getBDRelatedConditionStr(CommonFilter commonFilter)
	{
		...
		CommonMessage.debugMsg(commonFilter.getFailType().getId());		
		CommonMessage.debugMsg("rcccc+"+commonFilter.getRccchkbox());
		CommonMessage.debugMsg("rccccSS+"+commonFilter.getDesignchkbox());
		...
		CommonMessage.debugMsg("relCondtionStr="+relCondtionStr);
