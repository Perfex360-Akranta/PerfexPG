...
public class BAL_BdmTlPhencauseSql {
	...
	{
		return SqlUtils.getInsertSql(TBL_BAL_BDM_TL_CAUSEMST, fieldTypeArr, dataArray);
	}

	public static String getCauseUpdateSql(TableFieldType [] fieldTypeArr, Object [] dataArray)
	{
		String sql = SqlUtils.getUpdateSql(TBL_BAL_BDM_TL_CAUSEMST, fieldTypeArr, dataArray);
	...
	{
		String sql = "DELETE from " + TBL_BAL_BDM_TL_CAUSEMST ;
	...
	{
		return SqlUtils.getInsertSql(TBL_BAL_BDM_TL_PHNCAUSELINK, fieldTypeArr, dataArray);
	}

	public static String getPclUpdateSql(TableFieldType [] fieldTypeArr, Object [] dataArray)
	{
		String sql = SqlUtils.getUpdateSql(TBL_BAL_BDM_TL_PHNCAUSELINK, fieldTypeArr, dataArray);
...
//commented and added by priyanka on 02/07/2026
	/*
	 * public static String getPclDeleteSql(TableFieldType [] fieldTypeArr, Object
	 * [] dataArray) { String sql = "DELETE from " + TBL_BAL_BDM_TL_PHNCAUSELINK ;
	 * 
	 * sql += " where " +
	 * fieldTypeArr[tablePclFldConstants.originalid.ordinal()].fieldName + " = '" +
	 * (String)dataArray[ tablePclFldConstants.originalid.ordinal()] + "'"; return
	 * sql; }
	 */
	
	public static String getPclDeleteSql(TableFieldType[] fieldTypeArr, Object[] dataArray)
	{
	    String sql = "DELETE FROM " + TBL_BAL_BDM_TL_PHNCAUSELINK;

	    sql += " WHERE " + fieldTypeArr[tablePclFldConstants.originalid.ordinal()].fieldName +
	           " = '" + dataArray[tablePclFldConstants.elementid.ordinal()] + "'";

	    sql += " AND " + fieldTypeArr[tablePclFldConstants.parentid.ordinal()].fieldName +
	           " LIKE '%" + dataArray[tablePclFldConstants.parentid.ordinal()] + "%'";

	    sql += " AND " + fieldTypeArr[tablePclFldConstants.elementtype.ordinal()].fieldName +
	           " = 'CAS'";
