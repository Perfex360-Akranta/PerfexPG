...
public class BdmTlDtlSql {
	...
	public BdmTlDtlSql()
	{
		bdanDbFields = new TableFieldType[ 39 ];
		for(int i = 0;i < 39; i++)
		{	
	...
	{
		return SqlUtils.getInsertSql(TBL_BDM_TL_DTL, fieldTypeArr, dataArray);
	}

	public static String getUpdateSql(TableFieldType [] fieldTypeArr, Object [] dataArray)
	{
		String sql = SqlUtils.getUpdateSql(TBL_BDM_TL_DTL, fieldTypeArr, dataArray);
	...
	{
		String sql = "DELETE from " + TBL_BDM_TL_DTL ;
	...
	{
		return "SELECT * from "+TBL_BDM_TL_DTL+" where bdan_bdms_keyid = ?";
	}
