...
public class BAL_GenTlSparesmstSql {
	...
	public static String selectSql(CommonFilter commonFilter)
	{
		...
		CommonFunctions.debugMsg("commonFilter.getFromRow()"+commonFilter.getFromRow());
		CommonFunctions.debugMsg("commonFilter.getToRow()"+commonFilter.getToRow());
