...
public class BAL_BdmTlWhywhydtlSql {
	...
	{
		 String query= "select *  from " + TBL_BDM_TL_WHYWHYDTL + " where wwdt_wwms_keyid = '" + masterID + "'" ;
		 System.out.println("Select Query From with masterid bdmdtlsql "+query);
		 return query;
	} 
	
	public static String getSelectWhywhyDtls()
	{
		 String query= "select *  from BDM_TL_WHYWHYDTL  where wwdt_wwms_keyid = ? " ;
		 System.out.println("Select Query From bdmdtlsql "+query);
		 return query;
