...
public class WomTlCommunicationlogSql {
	...
	public WomTlCommunicationlogSql()
	{
	...
	{
		StringBuilder sql = new StringBuilder("DELETE from ").append(TBL_WOM_TL_COMMUNICATIONLOG ) ;
		sql.append(" WHERE WCML_KEYID ='");
		sql.append(keyid);
		sql.append("'");
