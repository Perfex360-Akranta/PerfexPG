...
public class PlmTlGenmaintenanceSql {
	...
	public PlmTlGenmaintenanceSql()
	{
		gmntDbFields = new TableFieldType[ 60 ];
		for(int i = 0;i < 60; i++)
		{	
	...
	public static String checkExist() {
		// TODO Auto-generated method stub
		CommonMessage.debugMsg("SELECT COUNT(*) FROM "+TableNames.TBL_PCS_TL_LOGCONFIGURATION + " WHERE PLCM_PARAMETERCODE = 'SETUPANDADJ'");
