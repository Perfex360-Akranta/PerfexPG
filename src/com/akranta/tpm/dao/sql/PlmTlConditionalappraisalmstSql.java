...
public class PlmTlConditionalappraisalmstSql {

	public static final String TBL_PLM_TL_CONDITIONALAPPRAISALMST = "PLM_TL_CONDITIONALAPPRAISALMST";  
	...
	public PlmTlConditionalappraisalmstSql()
	{
	...
	{
		return SqlUtils.getInsertSql(TBL_PLM_TL_CONDITIONALAPPRAISALMST, fieldTypeArr, dataArray);
	}

	public static String getUpdateSql(TableFieldType [] fieldTypeArr, Object [] dataArray)
	{
		StringBuilder sql = new StringBuilder( SqlUtils.getUpdateSql(TBL_PLM_TL_CONDITIONALAPPRAISALMST, fieldTypeArr, dataArray));
	...
	public static String getDeleteSql(TableFieldType [] fieldTypeArr, Object [] dataArray)
	{
		...
		sql.append(TBL_PLM_TL_CONDITIONALAPPRAISALMST );
		sql.append( " where " );
		sql.append(fieldTypeArr[tableFldConstants.keyid.ordinal()].fieldName ); 
		sql.append( " = '" );
		sql.append((String)dataArray[ tableFldConstants.keyid.ordinal()] );
	...
	public String getDeleteDetailSql(String cdamKeyid) {
		String sql=" DELETE FROM PLM_TL_CONDITIONALAPPRAISAL WHERE CDAP_CDAM_KEYID='"+cdamKeyid+"'";
		return sql;
	}
