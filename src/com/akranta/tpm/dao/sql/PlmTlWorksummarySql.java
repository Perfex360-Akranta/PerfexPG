...
public class PlmTlWorksummarySql {
	...
	public String updtCal(String wofbFeedbackid, String dateTime,
			...
			String pmCalendarId) {
		CommonMessage.debugMsg(wofbFeedbackid+"--"+dateTime+"--"+wofbCompletedby+"--"+wksmKeyid+"--"+fromDate+"--"+wofbDuration+"--"+pmCalendarId);
		// TODO Auto-generated method stub
	...
	public String updtPlanConfig(String dateTime, String fromDate,
		...
		// TODO Auto-generated method stub
		if(!UIUtils.isValidKeyId(assmbleyId))
			assmbleyId = "{}";
