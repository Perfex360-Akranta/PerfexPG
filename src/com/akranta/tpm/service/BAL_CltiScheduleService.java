...
public interface BAL_CltiScheduleService {
		...
		public String save(List<String> actlst, String cellId,String mchineId, String shiftId, String user_createdBy,String status,String Observation,String tagClass )throws Exception;
