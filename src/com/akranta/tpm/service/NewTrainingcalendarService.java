...
public interface NewTrainingcalendarService {
  ...
  public EntTlTragcalmst create(EntTlTragcalmst entTlTragcalmst,EntTlTragcalmst existntTlTragcalmst) throws Exception;
  public EntTlTragcalmst update(EntTlTragcalmst entTlTragcalmst,EntTlTragcalmst existntTlTragcalmst) throws Exception;
...
public List<ComboBox> getETTradeComboList(ComboFilter commonFilter) throws Exception;


public void NewTrainingcalendarServiceImplJwt(String string);
