...
public interface OplCummulativeService {

	List<String[]> getAlloplcumm(CommonFilter commonFilter) throws Exception;

	public Workbook getAlloplcummExl(CommonFilter commonFilter, JSONObject tblJSONObj,String format)throws Exception;
	...
	public void OplCummulativeServiceImplJwt(String string);
}
