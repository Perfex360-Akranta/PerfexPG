...
public interface MonthlyPlanEntryService {
	
	public List<String []> getMonPlan(CommonFilter commonFilte,String type)  throws Exception;
	...
	public BalPlmTlWofeedback saveWOD(BalPlmTlWofeedback newBalPlmTlWofeedback,
			BalPlmTlWofeedback existBalPlmTlWofeedback,
			BalWorkOrderDetailsBean workOrderDetailsBean) throws ValidationExceptions, SecurityException, IllegalArgumentException, ParserConfigurationException, SAXException, IOException, NoSuchMethodException, IllegalAccessException, InvocationTargetException, Exception;

	public String savegrdWOD(BalWorkOrderDetailsBean workOrderDetailsBean,
			BalWorkOrderFormBean newworkOrderFormBean,BalPlmTlWofeedback nwBalPlmTlWofeedback) throws Exception;
	...
	public String updateallocated(String workorderno, String updateWoId,
			String allotedtocombo,BalPlmTlWofeedback newBalPlmTlWofeedback)throws Exception;
	...
	public void setplmTlMultipleResp(List<BalPlmTlMultipleResp> multiResponse) throws Exception;

	
	public List<String[]> getMultipleReposibility(String pmwono,
			CommonParams commonParams)throws Exception;

	public String generateWO(String selActforWoGen, String strtDate,
			BalPlmTlWofeedback newBalPlmTlWofeedback) throws Exception;
