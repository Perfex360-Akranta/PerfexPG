...
public  class BAL_JhClitCalendarServiceImpl implements BAL_JhClitCalendarService {
	private DBActionTemplate dbActionTemplate;
private BAL_ClitCalValidations clitCalValidations;
private BAL_JhClitCalendarDao jhClitCalendarDao;

	public BAL_JhClitCalendarServiceImpl(DBActionTemplate dbActionTemplate)
	{
	...
	public List<String[]> getAlljhnfnGetScheduledArray(CommonFilter commonFilter) throws Exception
	{
		...
		try{
			...
			e.printStackTrace();
			System.out.print("in side caledar service ********"+e.getMessage());
		}
	...
	public BAL_JhclitCalendarModel delete( String flag) {
		// TODO Auto-generated method stub
		System.out.println("inside service Impl of delete");
	List<BAL_JhclitCalendarModel> newJhclitCalendarModel = new ArrayList<BAL_JhclitCalendarModel>();
	...
	public Workbook getJhnCalenderExportExcel(CommonFilter commonFilter,String format, String path, String imagePath) throws Exception {
		...
		List<String[]> jhCalenderData = jhClitCalendarDao.getjhnfnGetScheduledArray(commonFilter);
