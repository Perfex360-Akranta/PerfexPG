...
import com.akranta.tpm.dao.impl.MocNewDaoImpl;
...
public class MocNewServiceImpl implements  MocNewService{
	DBActionTemplate  dbActionTemplate ;
	MocNewDao mocDao;
	NotesMailClient notesMail;
	CommonFilterDao commonFilterDao;
	private Validations validations ;
	public MocNewServiceImpl(DBActionTemplate dbActionTemplate){
		 this.dbActionTemplate  =dbActionTemplate;
		// mocDao=new MocDaoImpl(dbActionTemplate);
		 mocDao=new MocNewDaoImpl(dbActionTemplate);
...
@Override
public MocRfcmstNew createMOC(MocRfcmstNew mocRfcmst, MocRfcmstNew existMocRfcmst,MocRfcBasismst mocRfcBasismst,MocTeamConfigmstNew mocTeamConfigmst)
		throws Exception {
	try {
...
@Override
public List<MocRfcBasismst> createMOCBasis(List<MocRfcBasismst> mocRfcBasismst, String createdBy, MocRfcmstNew mocRfcmst)
		throws Exception {
...
private List<MocRfcBasismst> fillValuesMOCBasis(List<MocRfcBasismst> mocRfcBasismst) {
	...
	{	
		...
		if ("MOCB0013".equals(genDescriptionLink.getRfcbbasisid())) {
            if (genDescriptionLink.getRfcbTempfield1() == null ||
                genDescriptionLink.getRfcbTempfield1().trim().isEmpty()) {
...
public MocRfcmstNew updateMOC(MocRfcmstNew mocRfcmst, MocRfcmstNew existMocRfcmst,String MocId,String Nature ,String Desc,String Detail, String Dmt,String Jh,String Initiator,String MOCTitle,String MocType, String noOfDays)
		throws Exception {
...
/*	CommonFunctions.debugMsg("Inside Create");
	...
	//fillValues(mocRfcmst,existMocRfcmst);
	return mocDao.update(mocRfcmst,MocId,Nature,Desc,Detail,Dmt,Jh,Initiator,MOCTitle,MocType,noOfDays);
}
@Override
public List<MocRfcBasismst> updateMOCBasis(List<MocRfcBasismst> mocRfcBasismst, String createdBy, MocRfcmstNew mocRfcmst)
		throws Exception {
	// TODO Auto-generated method stub
	return null;
}
private MocRfcmstNew fillValues(MocRfcmstNew mocRfcmst, MocRfcmstNew existMocRfcmst) {
	// TODO Auto-generated method stub
...
// 	Vignesh adding 11may 2026
	...
	if( mocRfcmst.getRfcmCapex() == null )
		mocRfcmst.setRfcmCapex("{}");
	if( mocRfcmst.getRfcmNoofdays() == null )
		mocRfcmst.setRfcmNoofdays("{}");
...
public void updateMocCapex(String mocKeyid, String capex, String modifiedBy) throws Exception {
    CommonMessage.debugMsg("Inside Service Impl updateMocCapex");
    mocDao.updateMocCapex(mocKeyid, capex, modifiedBy);
}
@Override
public String getOthersNotes(String mocKeyid) throws Exception {
    return mocDao.getOthersNotes(mocKeyid);
}


/*
 * @Override public List<MOCReccommendation>
 * createReccommendationNewHazop(List<MOCReccommendation>
 * mOCReccommendationList, String mocKeyidRec, String detailid,HazopMst
 * hazopMst,String catogery) throws Exception { // TODO Auto-generated method
 * stub return
 * mocDao.createReccommendation(fillValuesReccommendationNewTabHazop(
 * mOCReccommendationList,mocKeyidRec,detailid,hazopMst,catogery),
 * mocKeyidRec,detailid);
 * 
 * }
 * 
 * private List<MOCReccommendation>
 * fillValuesReccommendationNewTabHazop(List<MOCReccommendation>
 * mOCReccommendationList, String mocKeyidRec,String detailid,HazopMst
 * hazopMst,String catogery) { // TODO Auto-generated method stub
 * List<MOCReccommendation> newEntTlSessionEmployeeLinks
 * =mOCReccommendationList; List<MOCReccommendation>
 * newEntTlBatchEmployeeLinkList = new ArrayList<MOCReccommendation>(); int
 * index=0; if(mOCReccommendationList!=null) for( MOCReccommendation
 * genEntTlSessionEmployeeLink : newEntTlSessionEmployeeLinks) { //String
 * dateTime = CommonFunctions.dateTimeNow(); String dateTime =
 * CommonFunctions.pg_pldateTimeNow(); MOCReccommendation
 * genEntTlBatchEmployeeLink1 = newEntTlSessionEmployeeLinks.get(index);
 * index++; genEntTlSessionEmployeeLink.setMocrActive("Y");
 ...
 * 
 * if(UIUtils.isValidKeyId(hazopMst.getHzomKeyid())) {
 * genEntTlSessionEmployeeLink.setMocrmasterid(hazopMst.getHzomKeyid()); }
 * 
 * if(UIUtils.isValidKeyId(catogery)) {
 * genEntTlSessionEmployeeLink.setMocrCategory(catogery); }
 * 
 * if(UIUtils.isValidKeyId(hazopMst.getHazopDetails().get(0).
 * getMohdRecommentations())) {
 * genEntTlSessionEmployeeLink.setMocrrecmnd(hazopMst.getHazopDetails().get(0).
 * getMohdRecommentations()); }
 * 
 * 
 * 
 ...
 * newEntTlBatchEmployeeLinkList.add(genEntTlSessionEmployeeLink); } return
 * newEntTlBatchEmployeeLinkList;
 * 
 * }
 */
...
public List<MOCReccommendation> createReccommendationNewHazop(List<MOCReccommendation> mOCReccommendationList,
	...
	// TODO Auto-generated method stub
	return mocDao.createReccommendation(fillValuesReccommendationNewTabHazop(mOCReccommendationList,mocKeyidRec,detailid,hazopMst,catogery), mocKeyidRec,detailid); 

}

@Override
public String getMocBySuggestionId(String suggestionId) throws Exception {
	return mocDao.getMocBySuggestionId(suggestionId);
}


@Override
public boolean isMocApprovalUser(String mocKeyid, String userid) throws Exception {
    return mocDao.isMocApprovalUser(mocKeyid, userid);
}

private List<MOCReccommendation> fillValuesReccommendationNewTabHazop(List<MOCReccommendation> mOCReccommendationList, String mocKeyidRec,String detailid,HazopMst hazopMst,String catogery) {
	// TODO Auto-generated method stub
	...
	//for( MOCReccommendation genEntTlSessionEmployeeLink : newEntTlSessionEmployeeLinks)
		for (int i = 0; i < mOCReccommendationList.size(); i++)
	{	
		//String dateTime = CommonFunctions.dateTimeNow();
			MOCReccommendation genEntTlSessionEmployeeLink =
	                mOCReccommendationList.get(i);
		String dateTime = CommonFunctions.pg_pldateTimeNow();
...
//		if(UIUtils.isValidKeyId(hazopMst.getHazopDetails().get(0).getMohdRecommentations())) 
//		{
//			genEntTlSessionEmployeeLink.setMocrrecmnd(hazopMst.getHazopDetails().get(0).getMohdRecommentations());
//		}
//		
		
		  if (hazopMst.getHazopDetails()!= null
	                && hazopMst.getHazopDetails().size() > i) {

	            HazopDtl detail = hazopMst.getHazopDetails().get(i);

	            if (UIUtils.isValidKeyId(
	                    detail.getMohdRecommentations())) {

	                genEntTlSessionEmployeeLink
	                        .setMocrrecmnd( detail.getMohdRecommentations());
	            }
	            
	            if(UIUtils.isValidKeyId( detail.getMohdKeyid())) 
	    		{
	    			genEntTlSessionEmployeeLink.setMocrmasterid(detail.getMohdKeyid());
	    		}
	        }
...
//-- 13 may vignesh
@Override
public List<MocTeamConfigmstNew> createMOCTeam(List<MocTeamConfigmstNew> mocTeamConfigmst, String createdBy,
...
private List<MocTeamConfigmstNew> fillValuesMOCTeam(List<MocTeamConfigmstNew> mocTeamConfigmst) {
	// TODO Auto-generated method stub
	CommonMessage.debugMsg("In Fill Val MOC team");
	List<MocTeamConfigmstNew> newDescLinks =mocTeamConfigmst;
	List<MocTeamConfigmstNew> newLinkList = new ArrayList<MocTeamConfigmstNew>();
	
	int index=0;
	if(mocTeamConfigmst!=null)
	for( MocTeamConfigmstNew teamLink : newDescLinks)
	{	
		CommonMessage.debugMsg("In FMCT");
		String dateTime = CommonFunctions.pg_pldateTimeNow();
	//	String dateTime = CommonFunctions.pg_pggetFormatDateFromDate();
		MocTeamConfigmstNew getDescLink1 = newDescLinks.get(index);
		index++;
      ...
      /*  		
		...
		if( teamLink.getMctcInaprovedDte() == null )
			//teamLink.setMctcInaprovedDte("");dateTime
			teamLink.setMctcInaprovedDte(dateTime);
		...
		teamLink.setMctcInaproverwkdte(dateTime);
		...
		teamLink.setMctcHzaprovedDte(dateTime);
		...
		teamLink.setMctcHzaproverwkdte(dateTime);
		...
		teamLink.setMctcFaaprovedDte(dateTime);
		...
		teamLink.setMctcFaaproverwkdte(dateTime);
	...
	if( teamLink.getMctcTempfield10()  == null )
	 ...
	 // Vignesh 13-May-2026:
	if (teamLink.getMctcSecEmpid() == null) {
		teamLink.setMctcSecEmpid("");
	}
	 // Vignesh 13-May-2026:
...
/*
 * @Override public List<MOCReccommendation>
 * createReccommendationNew(List<MOCReccommendation> mOCReccommendationList,
 * String mocKeyidRec, String detailid,WhatifMst whatifMst,String catogery)
 * throws Exception { // TODO Auto-generated method stub return
 * mocDao.createReccommendation(fillValuesReccommendationNewTab(
 * mOCReccommendationList,mocKeyidRec,detailid,whatifMst,catogery),
 * mocKeyidRec,detailid);
 * 
 * }
 */
...
public List<MOCReccommendation> createReccommendationNew(List<MOCReccommendation> mOCReccommendationList,
		String mocKeyidRec, String detailid,WhatifMst whatifMst,String catogery) throws Exception {
	// TODO Auto-generated method stub
	return mocDao.createReccommendation(fillValuesReccommendationNewTab(mOCReccommendationList,mocKeyidRec,detailid,whatifMst,catogery), mocKeyidRec,detailid); 

}

private List<MOCReccommendation> fillValuesReccommendationNewTab(List<MOCReccommendation> mOCReccommendationList, String mocKeyidRec,String detailid,WhatifMst whatifMst,String catogery) {
	// TODO Auto-generated method stub
	List<MOCReccommendation> newEntTlSessionEmployeeLinks =mOCReccommendationList;
	List<MOCReccommendation> newEntTlBatchEmployeeLinkList = new ArrayList<MOCReccommendation>();
	int index=0;
...
//		if(UIUtils.isValidKeyId(whatifMst.getWifmKeyid())) 
//		{
//			genEntTlSessionEmployeeLink.setMocrmasterid(whatifMst.getWifmKeyid());
//		}
...
//		if(UIUtils.isValidKeyId(whatifMst.getWhatifDetails().get(0).getWifdRecommentations())) 
//		{
//			genEntTlSessionEmployeeLink.setMocrrecmnd(whatifMst.getWhatifDetails().get(0).getWifdRecommentations());
//		}
//		
		
		 // IMPORTANT FIX
        if (whatifMst.getWhatifDetails() != null
                && whatifMst.getWhatifDetails().size() > i) {

            WhatifDtl detail = whatifMst.getWhatifDetails().get(i);

            if (UIUtils.isValidKeyId(
                    detail.getWifdRecommentations())) {

                genEntTlSessionEmployeeLink
                        .setMocrrecmnd(detail.getWifdRecommentations());
            }
            
            if(UIUtils.isValidKeyId(detail.getWifdKeyid())) 
    		{
    			genEntTlSessionEmployeeLink.setMocrmasterid(detail.getWifdKeyid());
    		}
        }
...
/*
 * private List<MOCReccommendation>
 * fillValuesReccommendationNewTab(List<MOCReccommendation>
 * mOCReccommendationList, String mocKeyidRec,String detailid,WhatifMst
 * whatifMst,String catogery) { // TODO Auto-generated method stub
 * List<MOCReccommendation> newEntTlSessionEmployeeLinks
 * =mOCReccommendationList; List<MOCReccommendation>
 * newEntTlBatchEmployeeLinkList = new ArrayList<MOCReccommendation>(); int
 * index=0; if(mOCReccommendationList!=null) for( MOCReccommendation
 * genEntTlSessionEmployeeLink : newEntTlSessionEmployeeLinks) { String dateTime
 * = CommonFunctions.dateTimeNow(); MOCReccommendation
 * genEntTlBatchEmployeeLink1 = newEntTlSessionEmployeeLinks.get(index);
 * index++; genEntTlSessionEmployeeLink.setMocrActive("Y");
 * genEntTlSessionEmployeeLink.setMocrCreatedon(dateTime);
 * genEntTlSessionEmployeeLink.setMocrMocid(mocKeyidRec);
 ...
 * genEntTlSessionEmployeeLink.setMocrCategory(catogery); }
 * 
 * if(UIUtils.isValidKeyId(whatifMst.getWhatifDetails().get(0).
 * getWifdRecommentations())) {
 * genEntTlSessionEmployeeLink.setMocrrecmnd(whatifMst.getWhatifDetails().get(0)
 * .getWifdRecommentations()); }
 * 
 * 
 * 
...
public MocRfcmstNew getGridMocData(String mocKeyid) throws Exception {
	...
	MocRfcmstSqlNew mocRfcmstSql=new MocRfcmstSqlNew();
	...
	CommonMessage.debugMsg(" inside serviceimpl Fetched CapEx = " + mocRfcmst.getRfcmCapex());
	return mocRfcmst;
}
@Override
...
public HazopMst createHazop(HazopMst newHazopMst,HazopMst existHazopMst,String Keyid) throws BusinessApplicationExceptions,ValidationException,Exception{
	...
	/*
	 * public HazopMst UpdateHazop(HazopMst newHazopMst,HazopMst existHazopMst,
	 * String HazopKeyId,String CreatedBy) throws Exception{
	 * newHazopMst=fillHazopval(newHazopMst,existHazopMst); return
	 * mocDao.UpdateHazop(newHazopMst,HazopKeyId); }
	 */
...
public HazopMst UpdateHazop(HazopMst newHazopMst,HazopMst existHazopMst, String HazopKeyId,String CreatedBy,List<MOCReccommendation> mOCReccommendationList,String flid,String elementId) throws Exception{
	newHazopMst=fillHazopval(newHazopMst,existHazopMst);
	return mocDao.UpdateHazop(newHazopMst,HazopKeyId, mOCReccommendationList, flid,elementId);
}
...
{
    this.mocDao.DeletePssrReccommendationRow(keyid);
}
@Override
public String getPssrActionPlanKey(
    ...
    return mocDao.getPssrActionPlanKey(
        mocKeyid,
        psrrKeyid
    );
}
...
/*
 * public WhatifMst UpdateWhatif(WhatifMst newWhatifMst,WhatifMst
 * existWhatifMst,String CreatedBy,String WhatifKeyId) throws Exception{
 * newWhatifMst=fillWhatifval(newWhatifMst,existWhatifMst); return
 * mocDao.UpdateWhatif(newWhatifMst,CreatedBy,WhatifKeyId); }
 */

//Changes the parameters - whatif update - Swetha
public WhatifMst UpdateWhatif(WhatifMst newWhatifMst,WhatifMst existWhatifMst,String CreatedBy,String WhatifKeyId,List<MOCReccommendation> mOCReccommendationList,String flid,String elementId) throws Exception{
	...
	return  mocDao.UpdateWhatif(newWhatifMst,CreatedBy,WhatifKeyId,mOCReccommendationList,flid,elementId);
...
public List<String[]> getPillarChampionEmployeeList(String sugflid) throws Exception {
    return mocDao.getPillarChampionEmployeeList(sugflid);
}

@Override
public JSONArray readWhatIfExcelRows(String excelFileName) throws Exception {
    CommonMessage.debugMsg("Inside ServiceImpl readWhatIfExcelRows");
    return mocDao.readWhatIfExcelRows(excelFileName);
}

public JSONArray readHazopExcelRows(String excelFileName) throws Exception {
    CommonMessage.debugMsg("Inside ServiceImpl readWhatIfExcelRows");
    return mocDao.readHazopExcelRows(excelFileName);
}

@Override
public String Delete(String keyid) throws Exception {
	return mocDao.Delete(keyid);
}

@Override
public List<String[]> getInitialApprovedPrimaryRoleList(String mocKeyid) throws Exception {
    return mocDao.getInitialApprovedPrimaryRoleList(mocKeyid);
}

@Override
public List<MocTeamConfigmstNew> updateMOCTeam(
        List<MocTeamConfigmstNew> mocTeamConfigmst,
        String modifiedBy,
        MocRfcmstNew mocRfcmst) throws Exception {

    CommonMessage.debugMsg("In Service Impl Update MOC Team");

    return mocDao.updateTeam(
            fillValuesMOCTeam(mocTeamConfigmst),
            modifiedBy,
            mocRfcmst
    );
}
