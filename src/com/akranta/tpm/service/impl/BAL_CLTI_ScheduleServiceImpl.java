...
import com.akranta.tpm.dao.impl.BAL_CLTI_ScheduleDaoImpl;
...
//import com.akranta.tpm.dao.impl.JhClitCalendarDaoImpl;
...
public class BAL_CLTI_ScheduleServiceImpl implements BAL_CLTI_ScheduleService {
	private DBActionTemplate dbActionTemplate;
private BAL_ClitCalValidations clitCalValidations;
private BAL_CLTI_ScheduleDao jhClitCalendarDao;

	public BAL_CLTI_ScheduleServiceImpl(DBActionTemplate dbActionTemplate)
	{
		this.dbActionTemplate =dbActionTemplate;
		jhClitCalendarDao =  new BAL_CLTI_ScheduleDaoImpl(dbActionTemplate);
...
return jhnImgList;
	...
	public String save(List<String> actlst, String cellId,
			String mchineId, String shiftId,String createdBy,String status, List<String> obsernlst,List<String> tagclasslist) throws Exception {
		// TODO Auto-generated method stub
		return jhClitCalendarDao.save(actlst,cellId, mchineId,shiftId,createdBy,status,obsernlst,tagclasslist);
	}
