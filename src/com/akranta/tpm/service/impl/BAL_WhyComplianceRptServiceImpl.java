...
import com.akranta.tpm.dao.BAL_WhyComplianceRptDao;
import com.akranta.tpm.dao.impl.BAL_WhyComplianceRptDaoImpl;
import com.akranta.tpm.service.BAL_WhyComplianceRptService;

public class BAL_WhyComplianceRptServiceImpl implements BAL_WhyComplianceRptService{

	private BAL_WhyComplianceRptDao whyComplianceRptDao;
	
	
	public BAL_WhyComplianceRptServiceImpl(DBActionTemplate dbActionTemplate)
	{
		whyComplianceRptDao = new BAL_WhyComplianceRptDaoImpl(dbActionTemplate);
	...
	public List<String[]> getAllyycelldrill(String colIndex, CommonFilter commonFilter  )	throws Exception {
		...
		{
			System.out.println("colIndex.equalsIgnoreCase " + colIndex.equalsIgnoreCase("2"));
			code = "BDO";
		}
