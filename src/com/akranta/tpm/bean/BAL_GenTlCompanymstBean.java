...
public class BAL_GenTlCompanymstBean {
	...
	public BAL_GenTlCompanymstBean()
	{
	...
	public BAL_GenTlCompanymstBean(FormModes mode)
	{
	...
	public BAL_GenTlCompanymstBean(FormModes mode, String lockFields){
		formModeSettings(mode);
	...
	private void lockFormControls(String lockFields){
		...
		if( BAL_UIUtils.isValidKeyId(lockFields))
		{	
