...
public class BAL_GenTlSectionmstBean {
	...
	public BAL_GenTlSectionmstBean()
	{
	...
	public BAL_GenTlSectionmstBean(FormModes mode)
	{
	...
	public BAL_GenTlSectionmstBean(FormModes mode, String lockFields){
		formModeSettings(mode);
