...
public class BAL_GeneralMaintainanceBean {
	...
	public BAL_GeneralMaintainanceBean()
	{
	...
	public BAL_GeneralMaintainanceBean(FormModes mode) {
	...
	public String getIssparesY() {
		...
		public String getIssparesN() {
			System.out.println("Y Spares in N :: "+issparesN);
			return issparesN;
		}
