...
public class BAL_GenTlLocationmstBean {
	...
	public BAL_GenTlLocationmstBean()
	{
	...
	public BAL_GenTlLocationmstBean(FormModes mode)
	{
	...
	public BAL_GenTlLocationmstBean(FormModes mode, String lockFields){
		formModeSettings(mode);
