...
//For SAP Table
	...
	public BDFormBean(FormModes mode)
	{
	...
	private void formModeSettings(FormModes mode){
		...
		if( mode == FormModes.view ){
			...
			this.disableIssparesN=this.disableIssparesW=this.bdanFailuretype=this.bdmsPartlocationid=this.disablebdmsSpareid=true;
	...
	public void setIssparesY(String issparesY) {
		CommonMessage.debugMsg("Y Spares :: "+issparesY);
