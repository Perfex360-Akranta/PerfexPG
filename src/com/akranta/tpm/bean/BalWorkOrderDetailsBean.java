...
public class BalWorkOrderDetailsBean {
	...
	public BalWorkOrderDetailsBean(String mode) {
	...
	public BalWorkOrderDetailsBean() {
		this.formMode = "CREATE";
	}
	private List<String> gridData;
	private List<BalWorkOrderDetailsLstBean> grdWoBean;
...
*/
	...
	public void setGrdWoBean(List<BalWorkOrderDetailsLstBean> grdWoBean) {
		this.grdWoBean = grdWoBean;
	}

	public List<BalWorkOrderDetailsLstBean> getGrdWoBean() {
		return grdWoBean;
	}
