...
public class BAL_GenTlCellmstBean 
{
	...
	public BAL_GenTlCellmstBean(FormModes mode)
	{
		formModeSettings(mode);
		

	}
	public BAL_GenTlCellmstBean(FormModes mode, String lockFields){
		formModeSettings(mode);
