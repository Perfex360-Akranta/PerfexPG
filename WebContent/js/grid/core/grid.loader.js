...
{
    var pathtojsfiles = "js/grid/core/"; // need to be ajusted
    // set include to false if you do not want some modules to be included
    
        var modules = [
        { include: true, incfile:'language/lang-en.js'}, // jqGrid translation
        ...
        { include: true, incfile:'grid.setcolumns.js'} //jQuery UI utils
    ];
    var filename;
    for(var i=0;i<modules.length; i++)
    {
        ...
        if(modules[i].include === true) {
        	...
        	/***Added By Manikandan for grid  issue for IE**/
        	 /**||jQuery.browser.msie condition added in if for IE loading issue**/
			 //madhan
			 jQuery.ajax({
			     url: filename,
			     dataType: 'script',
