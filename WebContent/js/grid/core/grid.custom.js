	...
	filterToolbar : function(p){
		...
		return this.each(function(){
			...
			$.each($t.p.colModel,function(i,n){
				...
				/**Modified By manikandan changed the height from 100% to 25px;**/
				/**removed height:25px;min-height:25px; and  added margin-top*/
				thd = $("<div style='width:100%;position:relative;padding-right:0.3em;margin-top:0px;'></div>");
				...
				if(this.search){
					...
					case 'text':
						...
						if(cm.name!='')/*Added By manikandan to remove filter textbox in Grid**/
