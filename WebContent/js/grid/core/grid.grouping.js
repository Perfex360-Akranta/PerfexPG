...
$.jgrid.extend({
	...
	groupingCalculations : {
		...
		"customCount":function(v, field, rc){/**Added By Siddharth .A For OPL Summary groupBy Count **/
			if(v==="") {v=0;}
			rc[field]=="B"?v+=1:rc[field]=="X"?v+=0:v+=0;
			rc[field]=="I"?v+=1:rc[field]=="X"?v+=0:v+=0;
			rc[field]=="T"?v+=1:rc[field]=="X"?v+=0:v+=0;
			return	v;
		} 
