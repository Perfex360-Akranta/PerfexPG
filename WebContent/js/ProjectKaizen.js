...
*/	
	...
	jQuery('#chkKzpmIsintangible').click(function() {	
		...
		if(jQuery(this).is(":checked")){
			...
			jQuery('#chkKzpmIstangible').attr('checked', false);
			jQuery("#lblAmount").removeClass("mandatory-lbl");
...
function getWorkFlowStage(){
	...
	//	if(cStatus=="W" || cStatus=="R" || cStatus=="E" || cStatus=="L"){
			...
			workFlow("divConApproval",false,"FIPROCON", masterkeyid, "PROCO",flid,fromDate,toDate,enC);	
	//	}
	...
	//	else if(iStatus=="W" || iStatus=="R" || iStatus=="E" || iStatus=="L"){
			...
			workFlow ("divImpApproval",false,"FIPROIMP", masterkeyid, "PROIM",flid,fromDate,toDate,enI);	
	//	}
	//	else if(aStatus=="W" || aStatus=="R" || aStatus=="E" || aStatus=="L" ){
			...
			workFlow ("divAnlApproval",false,"FIPROANA", masterkeyid, "PROAN",flid,fromDate,toDate,enA);			
	//	}
	//	else if(mStatus=="W" || mStatus=="R" || mStatus=="E" || mStatus=="L" ){
			...
			workFlow ("divMeaApproval",false,"FIPROMEA", masterkeyid, "PROME",flid,fromDate,toDate,enM);	
	//	}
		/*else{
...
jQuery("#btnActionPlan").click(function(){
	...
	//alert(actDate);
	openActionPlan("divProActioPlan",keyid,"PRO",flid,mainTask,keyid,actDate,jQuery("#mode").val());
});
