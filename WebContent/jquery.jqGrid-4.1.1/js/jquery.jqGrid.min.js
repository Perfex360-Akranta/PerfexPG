...
R+"</span>").attr("id","v_"+J);r&&a("td:eq("+(N-1)+") span",P[0]).css({"text-align":"right",width:x+"px","font-size":50+"px"});X[Q]=z;Q++}});if(Q>0){g=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(j*2-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='"+g+"'/></td></tr>");g[0].rp=Q+99;a(L).append(g)}return X}function E(g,A){var L,j,J=0,S,P;if(P=a(A).jqGrid("getInd",g,true)){a("td",P).each(function(Q){L=A.p.colModel[Q].name;j=A.p.colModel[Q].editrules&&
