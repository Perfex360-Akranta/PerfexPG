    ...
    var formNavigations = [];
	   ...
	   /*  window.EASYUI_COMBO = {
		...
		<script src="js/jquery-3.7.1.min.js"></script>
          ...
          <script src="jquery.jqGrid-4.15.5/js/i18n/grid.locale-en.js"></script>
<script src="jquery.jqGrid-4.15.5/js/jquery.jqgrid.min.js"></script> 
<script src="jquery.jqGrid-4.15.5/js/grid.filter.js"></script> 
   ...
   // jQuery(function () {
        //console.log("jqGrid:", typeof jQuery.fn.jqGrid);
        //console.log("jgrid:", typeof jQuery.jgrid);
        //console.log("version:",jQuery.jgrid.version);
       // console.log("filterToolbar:",typeof jQuery.fn.jqGrid.filterToolbar);
    //});
...
(function () {
    if (!jQuery.browser) {
        ...
        jQuery.browser = {
            ...
            version: (ua.match(/(msie|rv:|firefox|chrome|version)[\/ ]([\d.]+)/) || [])[2] || "0"
        };
    }
})();
</script>
...
<script src="jquery.jqGrid-4.15.5/js/grid.filter.js"></script>  -->
	...
	<!-- 	<script src="js/jquery.jqGrid.min.js" type="text/javascript"></script> -->
        ...
        <script type="text/javascript" src="jquery-easyui-1.11.3/jquery.easyui.min.js"></script> 
          <script type="text/javascript" src="jquery-easyui-1.11.3/locale/easyui-lang-en.js"></script>
  ...
  //  });
		...
		<%-- <script type="text/javascript" src="js/CommonFunctions.js?v=${appVersion}"></script> --%>
...
<div id="passwordChg" ></div>
 ...
 <!--  <script type="text/javascript">
  alert("sessionScope.userLogin.password"+sessionScope.userLogin.password);
  alert("sessionScope.userLogin.defaultpwd"+sessionScope.userLogin.defaultpwd);
  </script> -->
  <input type="hidden"  id="hdnPassword" value="${sessionScope.userLogin.password  eq sessionScope.userLogin.defaultpwd ? true :false }" />
