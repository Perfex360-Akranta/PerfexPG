...
function messageBoard_successCalback(result){
	...
	jQuery('#ImgDelete').click(function(){
        ...
        alert("The userkeyid"+userkeyid);
        processAjaxCalls("chkEmployeeavl.edp","&userkeyid="+userkeyid,'chkEmployee_onsuccessCallBack','chkEmployee_onerrorCallBack');    
    ...
    function chkEmployee_onsuccessCallBack(result){
        ...
        var empcnt=result.EmpCount;
      //  alert("empcnt"+empcnt);
        if(empcnt!=null)
        {	
        if(empcnt=="0")
        {
        	 popupCommonErrorMsg("You Don't Have Rights to Delete any data from Perfex? Please contact Admin or TPM Cell!!!!");
        	 return false;
        }
        else{
        	deleteButtonPress();
 ...
 <div style="" class="headDividedImage">
	                   <table width="100%" height="100%" cellpadding="0" cellspacing="0">
	            		<tr>
	            			...
	            			<td width="34%" class="head_img1" ></td>
	            			<td width="48%" class="head_img2" ></td>
	            		</tr>
	            	</table>
...
<div class="wordwrap" style="float: right;font-size:10px; margin-top: -10px;color: #ffffff; width:27%">
    <c:out value="${sessionScope.userLogin.employeeName}"/>
