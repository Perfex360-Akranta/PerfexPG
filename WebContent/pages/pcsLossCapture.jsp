...
jQuery(document).ready(function(){
	...
	fillComboBox("frmPcsLoss","cmbPlosShiftid","shift.commonFilter?&frmRfilter=yes");
		...
		if (losshours.trim().length > 0 )
			{
					...
					//alert(' 1 ' + plosKeyid+' 2 '+pldetailsId);
					var url = "frmPcsLoss_save.pcs?&plosKeyid="+plosKeyid+"&pldetailsId="+pldetailsId+"&fromdate="+fromdate+"&todate="+todate;
				//	alert('1 .1 ' + plosKeyid);
					if (plosKeyid =="" || plosKeyid ==" " || plosKeyid == 'undefined')
						url+="&saveMode=create";
					else
						url+="&saveMode=update";
...
/*function frmPcsLoss_deleteSuccessCallback(result){
...
function lossDateEvt(dateField) { 
	
	var currentDate = getServerDateTime();
	var lossDate = jQuery('#'+dateField).datebox("getValue");
	...
	if(convertStringToDate(lossDate) > currentDate)
	{
		...
		{  
			...
			popupCommonErrorMsg(" Should Not Lessthan From Date");
			fillWithCurrentDate(dateField); 
			return false;
		}
...
function  getPCSShift(record)
{
	...
	function pcsdblClick(id) { 
		...
		var yyid = jQuery("#pcslossGrid").jqGrid('getCell',id,18);
		var kznid = jQuery("#pcslossGrid").jqGrid('getCell',id,20);
		var actplnid = jQuery("#pcslossGrid").jqGrid('getCell',id,22);

	//	alert(" yy :: "+yyid+" actplnid "+actplnid+" kznid :: "+kznid);
		...
		//alert(FromDate + " a "+ ToDate +" b " +fromtime + " c "+totime);
...
<td  style="padding-left:0px;">
 		...
 		<div>
	   	<input type="text" class="easyui-combobox"  id="cmbPlosCellid" name="cmbPlosCellid" value="${requestScope.QtmTlIntrejectionmst.qirmCellid}" style="width: 240px;"/>
	   	</div>
 </td>
 ...
 <td >
 		<label> Date </label>
 		<div>
	   	<input id="dtePlosDate" name="dtePlosDate" class="easyui-datebox"  readonly="readonly"  style="width: 90px;" value="${requestScope.date}"/>
	   	</div>
 </td>
...
<td valign="middle" style="padding-top:13px;" colspan="2">	
...
<div>
	...
	<span style="padding-left:170px;"> 	<label> Loss Name  </label> 	</span>
</div>
<div>
	<span style="padding-left:0px;">
		<input id="dtePlosFromdate" name="dtePlosFromdate" class="easyui-datebox" readonly="readonly"  style="width: 90px;" value="${requestScope.date}"/>
	...
	<span style="">
		<input id="dtePlosTodate" name="dtePlosTodate" class="easyui-datebox" readonly="readonly"  style="width: 90px;" value="${requestScope.date}"/>
	...
	<span style="padding-left:30px;display: none;">
		<input type="text" class="easyui-text"  id="txtPlosLosstime"   name="txtPlosLosstime"  value=""  style="width:80px;text-align: right;" disabled="disabled" maxlength="5" >
	</span>
	<span style="padding-left:30px;">
		<input type="text" class="easyui-text"  id="txLossHours"   name="txLossHours"  value=""  style="width:80px;text-align: right;" disabled="disabled" maxlength="5" >
	</span>
	<span style="padding-left:15px;">
		<input type="text"  class="easyui-combobox"  id="cmbPlosLossreason"   name="cmbPlosLossreason"  value=""  style="width:200px; height:23px;text-transform:uppercase;" />
	</span>
	<span style="padding-left:45px;">
		<input type="text"  class="easyui-combobox"  id="cmbPlosLossid"   name="cmbPlosLossid"  value=""  style="width:240px; height:23px;text-transform:uppercase;" />
	</span>
</div>
...
<div>
	<input type="text" class="easyui-text"  id="txtPlosLossdescription"   name="txtPlosLossdescription"  value=""  style="width:310px;" maxlength="500" >
	<span style="padding-left:28px;">
	<input type="text"  class="easyui-combobox"  id="cmbPlosTradeid"   name="cmbPlosTradeid"  value=""  style="width:170px; height:23px;text-transform:uppercase;" />
	</span>
	<span style="padding-left:10px;">
...
<div>
<table>
<tr style="float:right;margin-left:100%;margin-top:-40px;">
<td>
...
<td>
	<span style="padding-left:20px;">
		<input type="button"  class="easyui-button" id="btnLossDelete"	name="btnLossDelete" value="Delete" style=" width : 50px;height:20px;display: block;"/>
	</span>
</td>
<tr>
</table>	
