...
{	
	...
	if(reportName=="REVIEW") {
		...
		//alert(dataStr);
		dataStr+= "&filterButton=false";
		navigateToNextForm('multipleSkillIndexModfy_input.grdenty'+dataStr,"Multiple Skill Index Assement");
	}
	else if(reportName=="REPORT") {
			var flid = rowData.FLID;
			var uniqPosid = rowData.UNIQUEPOSID;
...
<table style="width: 120%;">
 <!-- <tr>
    ...
    <span style="padding-left:10px;"><label class="notes"> Double Click on row to input/view details </label></span>   <span style="padding-left:10px;"><label class="notes"> Double Click the Data row to view the Details </label></span>
   </div></td>
