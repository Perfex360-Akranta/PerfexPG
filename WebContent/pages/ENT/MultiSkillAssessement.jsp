...
jQuery(document).ready(function(){//alert("Multiassessement");
	...
	processGridnew("Multiskillassessment_input.postass","q=2","multiskillasssessmentgrid","multiskillasssessmentpager","","","","MultiOncompleteLoad");
	...
	loadFunctionalLocation("MSAfunLocation","functionalLoc.commonFilter","MSAfunLocationValues","frmMultiskillassessement",dataStr);
...
function frmMultiskillassessement_FuntLocHierarchy_SuccessCallBack(flIds){
...
<div id='multiskillasssessmentpager'></div>
