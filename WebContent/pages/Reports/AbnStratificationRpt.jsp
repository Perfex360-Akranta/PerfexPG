...
jQuery(document).ready(function(){	
	...
	jQuery('#btnGraph').click(function(){
		...
		var dataString = '?';
		if( jQuery("#chkZero").attr("checked"))
			{
			dataString += "&checkZero=Y";
			}
		else
			dataString += "&checkZero=N";	
		if( jQuery("#chkPercentage").attr("checked"))
		{
		dataString += "&chkPercentage=Y";
		}
		else
		dataString += "&chkPercentage=N";	
...
<div  style="padding-right:20px;margin-top:0px; width:500px;height:50px">
	...
	<span style="position:relative;top:5px\9;"><input id="btnGraph" class="easyui-button" style="padding-top:0;" type="button" value="Graph"/> </span>
	<!-- <span style="position:relative;top:5px\9;"><input id="btnBarGraph" name="btnBarGraph" class="easyui-button" style="padding-top:0;" type="button" value="Bar Graph"/> </span>
 --></div><br><br>
