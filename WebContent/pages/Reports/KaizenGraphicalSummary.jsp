...
jQuery(document).ready(function(){	
	...
	jQuery('#btnBarGraph').click(function(){
			...
			var url = "suggChart.imvscom";// + (rowid != null && rowid != 'undefined' ?  getParamName(rowid)+"="+rowid:"chType=p");
			//alert(url);
			showGraphData(url);
...
Double Click  on Company/Mill/SBU/PBU/DMT/JH to Drilldown
<table> 
<tr>
	<td>
...
<tr>
<td colspan="2">
<div><table id="impVscomp" style="width:100%;"><tr><td/></tr></table>
			 <div id="pager"></div>
			 </div>
			 </td>
 </tr>
