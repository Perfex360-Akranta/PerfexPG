...
jQuery(document).ready(function(){
	...
	var flid = jQuery("#frmComplaintGallery input[id='flid']").val();
   	fillComboBox("frmComplaintGallery","cmbCmgaGradespecification","comboGradeSpec.commonFilter?flid="+flid);
	fillComboBox("frmComplaintGallery","cmbCmgaDefectid","defphen.commonFilter?");
...
reloadCombo("frmComplaintGallery","cmbCmgaGradespecification","comboGradeSpec.commonFilter?flid="+flId);
}
