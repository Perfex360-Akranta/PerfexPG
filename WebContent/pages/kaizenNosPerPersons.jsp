...
function frmKaizenPerPerson_afterLoadCallBack(){
	...
	function fnShowKaizenGraph(graphType) {
		...
		FirstLevel = 'Y';
		//if (graphType=="LINE")
			var url = "chartKaizenNosPerPerson.kaz?q&graphType="+graphType+"&flid="+flid+"&FirstLevel="+FirstLevel+"&type="+type;
		//else
...
function viewGrid(url,filterString)
{
	...
	{	
		...
		processGridnew("TrnNosPerPersonPerMonth_input.kaz",filterString,"kznPerPersonGrid","pager",tableCaption,"doubleClickGrid","","kznPerPersonGrid_loadComplete");		
		return true;
	}
	return false;	
}
