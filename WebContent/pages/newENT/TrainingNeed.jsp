...
<table>
	<tr>
		...
		<td style="padding-top: 12px;padding-left:5px;"><label>Remarks</label>
			<div><textarea onkeyup="restrict(this.value,this.id)" onpaste="restrictPaste(this.value,this.id)" id="txtTnimRemarks" name="txtTnimRemarks" rows="2"  maxlength="498"  class="easyui-text" Style="width:250px;height:50px;font-size: 12" >${requestScope.Remarks}</textarea> 
			</div>
		</td>
