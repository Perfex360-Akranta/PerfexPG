	...
	jQuery("#btnview").click(function()
	 {
		...
		viewGrid("momattendancereport_input.mom", filterString);
...
function frmAttendaceReprtcmbMomaMeetingtype_onSelect(record)
{
	...
	var meetingtype = record.id; //getFieldValue('cmbMomaMeetingtype');
	if(meetingtype=="P")
	{
...
function frmAttendaceReprt_FuntLocHierarchy_SuccessCallBack(result) {
	...
	viewGrid("momattendancereport_input.mom",'?q=2&cellId=' + cellId+'&flid='+flId);
