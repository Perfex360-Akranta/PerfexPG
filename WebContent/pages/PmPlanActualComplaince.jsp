...
jQuery(document).ready(function(){	
	...
	hideShowBack(true);
	//setLoadFormCallBackFrmId("frmPMCompliance");
	viewGrid(url,"?q=2");
	});

/*function frmPMCompliance_afterLoadCallBack(){
	toggleCommonFilter();		
}*/
...
function viewGrid(url,filterString)
{
	...
	{
		var tableCaption = "PM Complaince";
		processGridnew(url,filterString,"list","pager",tableCaption,'','',"PmStd_LoadComplete");
