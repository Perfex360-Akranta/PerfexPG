...
jQuery(document).ready(function(){//alert(1);
   initialiseForm('frmAttendacemnthwseReprtDHQIS');
   //toggleCommonFilter();
    setFieldValue("cmbMomaMthMeetingtype", "J");
    fillComboBox("frmAttendacemnthwseReprtDHQIS","cmbMomaMthMeetingtype","MeetingAttType.mom?&type=monthwse","",false);
    fillComboBox("frmAttendacemnthwseReprtDHQIS","cmbMomaMthPillar","pillar.commonFilter");
    readOnlyFields("cmbMomaMthPillar");
    setLoadFormCallBackFrmId("frmAttendacemnthwseReprtDHQIS");
    invokeAfterLoadFormCallBack();
   
    var flids=jQuery("#hdnflids").val();
   // alert(flids);
...
function frmAttendacemnthwseReprtDHQIScmbMomaMthMeetingtype_onSelect(record)
{
...
function frmAttendacemnthwseReprtDHQIS_afterLoadCallBack(){
	toggleCommonFilter();	
}
...
{     
	...
	{   
		...
		var meetingtype = getFieldValue('cmbMomaMthMeetingtype');
		var pillarId=getFieldValue("cmbMomaMthPillar","frmAttendacemnthwseReprtDHQIS");
	    ...
	    var tableCaption = "Mom Attendance Month Wise Report-DHQ IS";
	  //  var JHId="FNL000124032";
	    var flids=jQuery("#hdnflids").val();
	   // alert(flids);
	    if(flids=="FNL000000049"){
	     //   alert("Check");
			processGridnew(url,filterString,"attendancemonthwisereportgrid","pagermonthwise",tableCaption,"docDoubleClick","","loadComFunction");		
			return true; 
	    }
	    else{
	    	alert("Unable to View this Screen");
	    	navigateToPrevForm();
	    	return false;
	    }
	}
...
<form name="frmAttendacemnthwseReprtDHQIS" id="frmAttendacemnthwseReprtDHQIS" action=" " method="post">
...
<input type="hidden" id="hdnflids" name="hdnflids" value="${requestScope.flids}">
</form>