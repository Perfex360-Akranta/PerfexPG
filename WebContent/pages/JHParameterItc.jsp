...
{	
	var rowId = options.rowId;
	return '<input id="txtMaxPoint_"'+rowId+' name="txtMaxPoint_"'+rowId+'   type="text"  value="'+id+'" style="width:150px;text-align:left"/>';
}
...
function FormattarMaxNumeric(id, options, rowObject)
{
	if(id=="undefined" || id == undefined) 
		id = "";
	var rowId = options.rowId;
	return '<input type="text" style="text-align:right;width:70px;font-family:arial;"  maxlength="1" onkeyup=allow10("numericMaxData_'+rowId+'"); onkeydown=allow10("numericMaxData_'+rowId+'"); id=numericMaxData_'+rowId +' value='+id+' >';	
}

function FormattarReviewPtSlNo(id, options, rowObject)
{
	var rowId = options.rowId;
	return '<input id="txtJautReviewPtSlno_'+rowId+'" name="txtJautReviewPtSlno_'+rowId+'" maxlength="3"  onfocus=gotFocuse("txtJautReviewPtSlno_","'+options.pos+'","'+rowId+'"); type="text"  value="'+id+'" style="width:30px;text-align:left"/>';
...
{
	var rowId = options.rowId;	
	return '<input id="txtJautCriteriaSlno_'+rowId+'" name="txtJautCriteriaSlno_'+rowId+'" maxlength="3" onfocus=gotFocuse("txtJautCriteriaSlno_","'+options.pos+'","'+rowId+'");  type="text"  value="'+id+'" style="width:30px;text-align:left"/>';	
}
...
{	
	...
	var rowId = options.rowId;	
 	...
 	return "<input id='desc_"+rowId+"'  style='text-align:left;width:500px;font-weight:normal;font-family:arial;' name='desc_txtbox' type='text' value ='"+id+"' />";
}
...
{	
	...
	var rowId = options.rowId;	
 	//return '<input type="text" style="text-align:left;width:390px;" id=desc_'+rowId +' value='+id +' >'; 	
 	return "<input id='evidence_"+rowId+"'  style='text-align:left;width:200px;font-weight:normal;font-family:arial;' name='evidence_txtbox' type='text' value ='"+id+"' />";
}
...
{	
	...
	var colVal = escape(id);
 	...
 	return "<input id='paramName_"+rowId+"'  style='text-align:left;width:300px;font-family:arial;' name='paramName_txtbox' type='text' value ='"+unescape(colVal)+"' />";
}
...
function FormattarKeyId(id, options, rowObject)
{
	if(id=="undefined" || id == undefined) 
		id = "";	
	var rowId = options.rowId;	
 	return '<input type="text" style="text-align:right;width:150px;font-family:arial;"  id=keyId_'+rowId +' value='+id +' />'; 	
}
