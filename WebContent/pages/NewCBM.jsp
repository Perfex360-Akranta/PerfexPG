   	 ...
   	 // alert(dataStr);
   	  loadFunctionalLocation("TrainingFBfunLocation", "functionalLoc.mom", "TrainingFBfunLocation", "frmcbm",dataStr);
	      ...
	      // imageUpload(jQuery( "#btnnew" ),'ImageUpload.commonFilter','btnnew',"imgknowimage","imgknowImgFilename");
	       fileManagerPopUp("","ABN","frmcbm","btnnew","abnFilemgr");   
	   	});
...
<div id="frmmomFuntKeyIds">
     ...
     <div  class="easyui-paddingbfpx" id="TrainingFBfunLocation" style="width: 64%;width:60%\9;padding-left:0px;"></div>

   <label>Equipment</label>
   <div>
          <input class="easyui-text"id="cmbEquimentName" name="cmbEquimentName"  style="width: 200px;height: 22px;"value="" />
       <span style="padding-left:28%"><input type="button" class="easyui-button" id = "btnnew"  value = "XL FileFormat" style="height: 20px; width : 102px;" />
       </span></div>
       <div style="position:relative;">
			 <span  id="abnFilemgr" style="position:absolute;right:-138px;right:-144px\9;top:-24px;top:-28px\9;" >
...
<table id="cbmGrid" ></table>
 ...
 <!-- <input type="hidden" id="hdnBtnName" value="ViewFormat"/> -->
