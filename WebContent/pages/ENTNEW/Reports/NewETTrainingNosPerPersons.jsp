...
function frmKaizenPerPerson_afterLoadCallBack(){
	...
	function fnShowKaizenGraph(graphType) {
		...
		FirstLevel = 'Y';
		//if (graphType=="LINE")
			var url = "chartNewETNosPerPerson.newentRpt?q&graphType="+graphType+"&flid="+flid+"&FirstLevel="+FirstLevel+"&type="+type;
		//else
...
function viewGrid(url,filterString)
{
	...
	{	
		...
		processGridnew("NewTrnNosPerPersonPerMonth_input.newentRpt",filterString,"kznPerPersonGrid","pager",tableCaption,"doubleClickGrid","","kznPerPersonGrid_loadComplete");		
		return true;
	}
	return false;	
}
