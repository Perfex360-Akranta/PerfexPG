...
{	
	setDrillDownHeader("CH1-0","skillIndexGrid","KEYFIELD2");
...
function viewGrid(url,filterString)
{
	...
	{		
		...
		//http://localhost:6080/perfexitc/NewAverageSkillIndexRpt_input.newentRpt
		processGridnew("NewAverageSkillIndexScore_input.newentRpt",filterString,"skillIndexGrid","pager",tableCaption,"doubleClickGrid","","skillIndexGrid_loadComplete");		
		return true;
	}
...
function skillIndexGrid_onProcessGridBack(){
	...
	setDrillProcesGridBack("skillIndexGrid","KEYFIELD2",keyfieldData);
	jQuery("#hdnFnlnKeyid").val("");
}			
					
function doubleClickGrid(id){ 
	var keyfieldData=jQuery("#hdnFnlnKeyid").val();
	keyfieldData=setDrillDoubleClick("skillIndexGrid","KEYFIELD2",id,keyfieldData);
