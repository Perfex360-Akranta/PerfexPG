...
jQuery(document).ready(function(){	
	...
	jQuery("#btnview").click(function( ){
        ...
        processGridnew("NewSkillGapReport_input.newentRpt",dataString,"skillgapreportlist","skillgapreportpager");
	...
	function viewGrid(url,dataString)
	{
	 ...
	 function frmskillGapReportcmbSkillEmployee_onSelect(record)
	 {
	     ...
	     processAjaxCalls("NewSkillGapReport_recall.newentRpt?&type=SkillGap&KEYID="+record.id,"","recallsuccessCallBack","errorCallBack");
