	 ...
	 setFieldValue('cmbWogenAssemblyid', assmId,'frmWOGen');
  	...
  	//when coming back from resource planning this will happen
  	 if(whenBack.trim().length>0){
		...
		processGridnew('completeWO_input.mpce','?q=2&filterString='+jQuery('#hdnfilter_string').val(),"CompWOGrid","","","CompWODBLClick","","CompWOGridComplete");
  	 }
...
//		var rowid = jQuery("#CompWOGrid").jqGrid('getDataIDs');  
		...
		if(jobType == "CBM"){
			...
			//	LoadPopUp("divOpenCBM","cbmWO_input.mpce?inspectionId="+inspectionid+"&uomId="+uomid+"&pmsdId="+pmstandId+"&hdnCurReadId="+hdnCurReadId+"&hdnCBMWodata="+hdnCBMWodata+"&hdnzoneCondition="+hdnzoneCondition+"", true,"90%","96%","-3","4%", "CBMOk_Callback","CBM");
		}
		else
			jQuery('#popCBMReadings').hide();
		//else{	
		...
		//jQuery(".tabs-title").bind("click", function(event){
				...
				{	
				 ...
				 else if(title == "CBM" )
					{
						...
						var woId=jQuery('#txtWogenwoNo').val();									
						processGridnew('completeWO_input.mpce','?q=2&filterString='+jQuery('#hdnfilter_string').val(),"CompWOGridcbm","","","CompWODBLClick","","CompWOGridComplete");
						  // processGridnew('empCostActual_view.crt',"?q=2&formName=empCost&woId="+ woId,"tblEmpCostActGrid","empCostActPager","","tblEmpCostActGrid_dblClick","","costGridLoad","");
					}
				 else if(title == "TBM" )
					{
						...
						var woId=jQuery('#txtWogenwoNo').val();									
						processGridnew('completeWO_input.mpce','?q=2&filterString='+jQuery('#hdnfilter_string').val(),"CompWOGridtbm","","","CompWODBLClick","","CompWOGridComplete");
						  // processGridnew('empCostActual_view.crt',"?q=2&formName=empCost&woId="+ woId,"tblEmpCostActGrid","empCostActPager","","tblEmpCostActGrid_dblClick","","costGridLoad","");
					}
				else if(title == "Cost Info" )
				{
