...
var currentDateCBM ;
	...
	fillComboBox("frmWOGen","cmbWogenAssemblyid","assembly.commonFilter");
	 setFieldValue('cmbWogenAssemblyid', assmId,'frmWOGen');
	  ...
	  var dataStr = "&factId="+factId+"&sectionId="+sectionId+"&cellId="+cellId+"&machId="+machId+"&flid="+flid;	  					
	    loadFunctionalLocation("genwfunLocation","functionalLoc.Bbrdn","genwfunLocationValues","frmWOGen",dataStr);
  ...
  function communication_successCallBack(){
		 var workorderNo = jQuery('#txtWogenwoNo').val();
		  ...
		  processGridnew('comm_view.Bbrdn','?q=2&bdId='+workorderNo+'&commFlag=no&frmForm=pm',"CommnGrid","","","","","commComplete","");
...
function getZoneCbmReading(cbmrelated,chkReadingValStr, isCBMAction){
  ...
  function selectData(rowId){
	  ...
	  var servdate = new Date(srvTime());
	     ...
	     if(title=="CBM"){		   	
			    ...
			    //Swetha
			    jQuery("#txtobservation_"+rowId)
		        .prop("disabled", false)
		        .removeAttr("disabled")
		        .css("display", "block");
			  	var sectId = jQuery("#frmWOGen input[id='section']").val();			  	
			  	setFormater("CompWOGridcbm","frmWOGen","",rowId,"dteObsvTargetDate");			  	
			  	setFormater("CompWOGridcbm","frmWOGen","employee.commonFilter?dept=maintenance&sectId="+sectId,rowId,"cmbObsvResponName","hdnObsvResponsibility","180",false, false, false);
				...
				setFormater("CompWOGridcbm","frmWOGen","",rowId,"txtCbmReading",null,null,null,false,true);
				setFormater("CompWOGridcbm","frmWOGen","",rowId,"txtCbmAdjustedReading",null,null,null,false,true);
				setFormater("CompWOGridcbm","frmWOGen","",rowId,"dteCbmNextDueDate");
		    ...
		    enableFields('txtDuration_'+rowId);
		    enableFields('txtremarks_'+rowId);
		    var observationId = "#txtobservation_" + rowId;

		    console.log("Observation ID:", observationId);
		    console.log("Observation element:", jQuery(observationId).length);
			//Swetha
		    jQuery(observationId)
		        .prop("disabled", false)
		        .removeAttr("disabled")
		        .css("display", "block");
		    //jQuery("#txtobservation_"+rowId).removeAttr("disabled");
		  	setFormater("CompWOGridtbm","frmWOGen","",rowId,"dteObsvTargetDate");
		  	setFormater("CompWOGridtbm","frmWOGen","employee.commonFilter?dept=maintenance&sectId="+sectId,rowId,"cmbObsvResponName","hdnObsvResponsibility","180",false, false, false);
			...
			jQuery('#txtremarks_'+rowId).css('display','block');
		  	...
		  	activity = jQuery("#CompWOGridcal").jqGrid('getCell',rowId,"frequency");
			jQuery("#spnShowActivity").html("Frequency-[Assembly]-Activity : " + activity);  	
		    ...
		    var sectId = jQuery("#frmWOGen input[id='section']").val();	  	
		  	setFormater("CompWOGridcal","frmWOGen","",rowId,"dteObsvTargetDate");	  	
		  	setFormater("CompWOGridcal","frmWOGen","employee.commonFilter?dept=maintenance&sectId="+sectId,rowId,"cmbObsvResponName","hdnObsvResponsibility","180",false, false, false);
			var servdate = new Date(srvTime());
		  	var currentDate = new Date(servdate.getFullYear(),servdate.getMonth(),servdate.getDate());
		  	currentDateCBM = servdate;
			//var frequncy = jQuery("#CompWOGrid").jqGrid('getCell',rowId,"frequency"); 
		  	jQuery("#CompWOGriddteObsvTargetDate_"+rowId).datebox({onSelect:function(date){
		  	 ...
		  	 cm = jQuery("#CompWOGridcal").jqGrid("getGridParam", "colModel");  	 
		  	  jQuery('#selRowId').val(rowId);
		  	  
				jQuery('#txtactionTaken_'+rowId).val('DONE');
					 planVal = jQuery("#CompWOGridcal").jqGrid('getCell',rowId,cm[10].name);				
					 jQuery('#txtDuration_'+rowId).val(planVal);
					 jQuery("#CompWOGridcal").setCell(rowId, "hdnchkSel","1");						 
				  	 jQuery("#selectedDat").val(rowId);
				  	 jQuery('#txtactionTaken_'+rowId).css('display','block');
					 jQuery('#txtDuration_'+rowId).css('display','block');
					 jQuery('#txtremarks_'+rowId).css('display','block');
  ...
  function showCBMReadings(rowId){
	  ...
	  console.log("rowId =", rowId);
	    console.log("cbmrelated =", cbmrelated);
...
//alert(greenC +"greenC");
  ...
  function unselectData(rowId){
	  ...
	  if(title=="CBM"){
		  ...
		  //removeFormater(gridId,formtType,rowId,value,colName);
		/*  removeFormater("CompWOGridcbm","frmWOGen",rowId,"","cmbObsvResponName");
		  removeFormater("CompWOGridcbm","frmWOGen",rowId,"","txtCbmReading");
		  removeFormater("CompWOGridcbm","frmWOGen",rowId,"","txtCbmAdjustedReading");
		  removeFormater("CompWOGridcbm","frmWOGen",rowId,"","dteCbmNextDueDate");
		*/	
		  ...
		  //removeFormater(gridId,formtType,rowId,value,colName);
		  removeFormater("CompWOGridtbm","frmWOGen",rowId,"","cmbObsvResponName");
		  removeFormater("CompWOGridtbm","frmWOGen",rowId,"","txtCbmReading");
		  removeFormater("CompWOGridtbm","frmWOGen",rowId,"","txtCbmAdjustedReading");
		  removeFormater("CompWOGridtbm","frmWOGen",rowId,"","dteCbmNextDueDate");
 ...
 function genWODBLClick(id){
	...
	//	 fillMachineHierarchy("machineHierarchy.commonFilter",machineId,"cmbgenwCellid","cmbgenwSectionid ","cmbgenwFactoryid","", "","cmbWogenCostCenter");
		...
		jQuery(".spnComplfields").css('display','block').css('margin-left','780px').css('vertical-align','top').css('margin-top','-20px');
		jQuery(".spnComplBtn").css('display','block').css('margin-left','1060px').css('vertical-align','top').css('margin-top','-28px');;
	 	processGridnew('completeWO_input.mpce',filterString,"CompWOGrid","","","CompWODBLClick","","CompWOGridComplete");
...
/*			if(screen.width <= 1024) 
 ...
 //Swetha Addition
 function preventGridFocusIssue(gridId) {

	    var grid = jQuery("#" + gridId);
	    
	    jQuery(grid).jqGrid('setGridWidth', jQuery("#tabWorkOrder").width() - 100);

	    // Prevent grid from taking control when clicking textarea
	    grid.off("mousedown.gridFocus", "textarea")
	        .on("mousedown.gridFocus", "textarea", function(e) {
	            e.stopPropagation();
	        });

	    // Give focus to textarea
	    grid.off("click.gridFocus", "textarea")
	        .on("click.gridFocus", "textarea", function(e) {
	            e.stopPropagation();
	            this.focus();
	        });

	    // Prevent grid from taking control when clicking EasyUI textbox
	    grid.off("mousedown.gridFocus", "input.textbox-text")
	        .on("mousedown.gridFocus", "input.textbox-text", function(e) {
	            e.stopPropagation();
	        });

	    // Give focus to EasyUI textbox
	    grid.off("click.gridFocus", "input.textbox-text")
	        .on("click.gridFocus", "input.textbox-text", function(e) {
	            e.stopPropagation();
	            this.focus();
	        });
	 ...
	 // CBM READING
	    grid.off(
	        "mousedown.gridFocus",
	        "input[id^='CompWOGridcbmtxtCbmReading_']"
	    ).on(
	        "mousedown.gridFocus",
	        "input[id^='CompWOGridcbmtxtCbmReading_']",
	        function(e) {
	...
	jQuery(".zoneColor").each(function(){
	 ...
	 if(mode == 'Y'){
		...
		if(title=="CBM"){
		 ...
		 var sumval = 0;
			var planVal ="";
			preventGridFocusIssue("CompWOGridcbm");
			 for(var i=0;i<rowid.length;i++)
			 {
				 //jQuery("#CompWOGridcbm_txtWofbObservation"+i).on('mousedown click', function(e){
					   // e.stopPropagation();
					//});
				 ...
				 //CompWOGridcbm_txtWofbObservation
			 ...
			 var sumval = 0;
				var planVal ="";
				preventGridFocusIssue("CompWOGridtbm");		    
			 ...
			 var sumval = 0;
				var planVal ="";
				preventGridFocusIssue("CompWOGrid");	
				 for(var i=0;i<rowid.length;i++)
				 {
					 if(mode == 'Y' )
			 ...
			 rowid = jQuery("#CompWOGridcal").jqGrid('getDataIDs');
			 var sumval = 0;
				var planVal ="";
				 for(var i=0;i<rowid.length;i++)
				 {
					 if(mode == 'Y' )
					 	jQuery("#CompWOGridcal").setCell(rowid[i], "hdnchkSel","1");
					 	
					 planVal = jQuery("#CompWOGridcal").jqGrid('getCell',rowid[i],"plannedduration");	
					 sumval += parseInt(planVal,10);
...
function frmWOGen_beforeSubmit(){
	...
	if(title=="CBM"){
		 ...
		 gridData = getSelectdRows("CompWOGridcal","status","hdnchkSel");
...
function frmWOGen_successsCallback(result){
	...
	if(title=="CAL"){
		jQuery('#CompWOGridcal').trigger("reloadGrid");
		}
	//jQuery('#CompWOGrid').trigger("reloadGrid");
	...
	var cm="";
	  var title = jQuery('#tabtitle').val();
		if(title=="CBM"){
			...
			allRows = jQuery("#CompWOGridcal").jqGrid('getRowData');
			cm = jQuery("#CompWOGridcal").jqGrid("getGridParam", "colModel");
 ...
 /*****For tabs******/
	...
	jQuery("#tabWorkOrder").tabs({ onSelect:function(title){     					
		//jQuery(".tabs-title").bind("click", function(event){
				...
				{	
						...
						LoadForm("loadCommunicDiv","prevloadComText","comm_Text.Bbrdn?&formMode=create&mode=pm&workorderNo="+workorderNo+"&employeeId="+employeeId,"","communication_successCallBack","communicationTextErr");
	    		...
	    		if(jQuery('#chkformatter').is(':checked')==true){
					 ...
					 if(confirm(sapMsg) == false)
					{
						 ...
						 alert("Select The Submit SAP");				 
							...
							LoadForm("loadSapinfoDiv","prevloadSapinfoText","sapInfo_input.Bbrdn?refDocType="+refDocType+"&bdkeyId="+pmWOKeyid+"&isSpres=Y&flid="+flid,"","sapInfoComplete","sapInfoErr");
	...
	jQuery('#btnTabSelect').click(function()
		...
		//"GenWOGrid","GenWOPager","","genWODBLClick"
						var rowid = jQuery("#GenWOGrid").jqGrid('getGridParam','selrow');
						if(rowid=='' || rowid== null){
	...
	<tr>
		<td style="padding-left:20px;">
			...
			<span  class="leftmtsect" style="">
             ...
             <span >
		  		<label style="margin-left:88px">Work Order No</label>      
            ...
            <div class=""> 
             ...
             <span class="easyui-paddingbfpx" style="padding-left:10px;">  
              ...
              <span class="easyui-paddingbfpx" style="padding-left:10px;">  
				...
				<!--  <input type="button" value="Back" id="backBtn2nd" class="easyui-button" style="height:25px"> -->
				</span>
		...
		<!--    <input style="margin-left:300px; margin-top:-10px;  height:25px" type="button"  value="Select All" class="easyui-button"  id="selectAll" name="selectAll"/></span>		
		-->
		
		 <span style="padding-left:486px; margin-top:-10px;"><label style='padding-left:1px;'><b> Submit To SAP </b> </label>	
		 <input style="padding-left:486px; margin-top:-10px;" type="checkbox"  id="chkSapinfo" name="chkSapinfo"/></span>		
				
			<!-- <label id="spnShowActivity" style="padding-left: 5px;"></label></div> -->
<!--			 Tabs   -->
  	
					<!-- Swetha Height -->
			<div  id="tabWorkOrder" class="easyui-tabs"  style="width:1200px;height:auto;margin-top:0;
            float:left;
       overflow:no;padding: 15px;">
			          <div title="PRM"  style="padding-right:  0px;" index='0'>
						<table id="CompWOGrid" style="width:100%; "><tr><td/></tr></table>
						
						<!-- <div id="CompWOPager"></div> -->
					</div>
					 <div title="CBM"  style="padding-right:  0px;" index='0'>
						<table id="CompWOGridcbm" style="width:100%; "><tr><td/></tr></table>
						
						<!-- <div id="CompWOPager"></div> -->
					</div>
					 <div title="TBM"  style="padding-right:  0px;" index='0'>
						<table id="CompWOGridtbm" style="width:100%; "><tr><td/></tr></table>
						
						<!-- <div id="CompWOPager"></div> -->
					</div>
					<div title="CAL"  style="padding-right:  0px;" index='0'>
						<table id="CompWOGridcal" style="width:100%; "><tr><td/></tr></table>
