  ...
  */
	...
	function RootCauseComplete()
	{
		...
		<tr style="padding-left:0px;">
        	...
        	<input type="text" class="easyui-text" readonly="readonly" id="txtbdanWwno" name="txtbdanWwno" value="${requestScope.bdmTlDtl.bdanWwno}" style="width: 90px" <c:out value = "${requestScope.bdFormBean.disablebdmsEntrydate == true ? ' disabled':''}"/>/></td>
	...
	<!--        <div class="floatleft sub-header" style=" width : 305px; height : 17px;margin-bottom:10px;margin-left:10px;">Kaizen idea and Schedule Details </div>	-->
        	...
        	<td>
		       ...
		       <div style="float: left;margin-top:4px;">
		       		<textarea onkeyup="restrict(this.value,this.id)" onpaste="restrictPaste(this.value,this.id)" style="width : 205px; height : 130px;resize:none" name="txtbdanPreventivemeasure" id="txtbdanPreventivemeasure" >${requestScope.bdmTlDtl.bdanPreventivemeasure}</textarea>
		       </div>
        	</td>
        	</tr>
        </table>
...
<!--       		<textarea onkeyup="restrict(this.value,this.id)" onpaste="restrictPaste(this.value,this.id)" style="width : 305px; height : 195px;resize:none" name="txtbdanPreventivemeasure" id="txtbdanPreventivemeasure" >${requestScope.bdmTlDtl.bdanPreventivemeasure}</textarea>-->
<!--       </div>	-->
