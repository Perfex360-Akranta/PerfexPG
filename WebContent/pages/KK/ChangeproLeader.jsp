...
{	
	...
	{		 
		...
		processGridnew("ChangeProLeader_input.prpo", filterString, "projectgrid", "pager",tableCaption,"docDoubleClick","","loadProto_complete");
		return true;
	}
	return false;
}
		...
		if(jQuery('#jqg_'+ gridId +'_'+rowId).is(':checked')== true)
		 {
			...
			processAjaxCalls("changeprojectLeader_select.prpo","?q=2&Keyid="+Projectid,"frmoldemployee_successsCallback"," ");
            setTimeout(function() {
            	var hdnoldemployeenameid = jQuery("#hdnoldemployeenameid").val();
    			//alert(hdnoldemployeenameid);
    			LoadPopUp("divChangeprolead","ChangeProLeaderBankPopup_select.prpo?q=2&Projectid="+Projectid+"&oldemployeenameid="+hdnoldemployeenameid,true,"35%","30%","8%","8%","LoadSuccess","Change Project leader ","","");
