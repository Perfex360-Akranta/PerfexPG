...
//		ViewGrid(url,"");
	...
	{	
		...
		if(columnName=="ProjectScore"){
			...
			return '<span><input type="text" id="'+idval+columnid + '_'+id +'" disabled="disabled"  style="width:'+ width +'px;text-align:right;" onfocus="gotFocuse(this.id);" value="'+rowObject[columnid - 1]+'" maxlength="3"></span>';
          }
