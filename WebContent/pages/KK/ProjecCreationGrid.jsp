...
jQuery(document).ready(function(){	
	...
	jQuery('#btnNew').click(function(event){
		getProjectCreation("projectsprotoview_input.prpo?q=2&mode=insert");
	});
	viewGrid("","");	
...
function doubleClickGrid(rowid) 
{
	...
	getProjectCreation("projectsprotoview_input.prpo?keyid="+keyId+"&mode=modifycreate");
}	
