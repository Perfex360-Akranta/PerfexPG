...
{	
	...
	{		 
		...
		//alert(filterString);
		processGridnew("projectsprotomainView_input.prpo", filterString, "projectgrid", "pager",tableCaption,"docDoubleClick","","loadProto_complete");
		return true;
	}
	return false;
}
