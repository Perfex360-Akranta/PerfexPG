...
var uploader = new qq.FileUploader({
      	...
      	<div >
	       	<table style="width:98%;">
	       		<tr>
					...
					<td  style="padding-left:2px;width:300px">												
						<div class="">
						...
						<div>
							<input id="dteKzpmStartdate" name="dteKzpmStartdate" class="easyui-datebox"  value="${requestScope.Project.kzpmStartdate}" style="width:80px;width:80px;\9" />
							<span style="margin-left:1%;">
							<input id="dteKzpmEnddate" name="dteKzpmEnddate" class="easyui-datebox"  value="${requestScope.Project.kzpmEnddate}" style="width:80px;width:80px;\9" />
							</span>	
							<span style="margin-left:1%;">
							<input class="easyui-text"  maxlength="2" style="height:21px;width:30px;" id="txtKzpmWave" name="txtKzpmWave" value="${requestScope.Project.kzpmWave}" />
							</span>	
							<span style="margin-left:1%;">
							<input class="easyui-combobox"  maxlength="2" style="/* height:21px; */width:45px;" id="cmbKzpmBelt" name="cmbKzpmBelt" value="${requestScope.Project.kzpmBelt}" />
							</span>					
						</div>	
						<table>
								<tr>
			   		...
			   		<td valign="top" align="left" style="padding-left: 1% ">
			            ...
			            <div class="sub-header" id="DMAIC" style="margin-left:1px; text-align: left;font-size:15px;float:left;width:100px; width:100px\9;height:18px\9;padding-right: 10px;">
					...
					<td valign="top" align="center" style="padding-left: 1% ">
			            ...
			            <div class="sub-header" id="DMAICTD" style="margin-left:0px; text-align: left;font-size:15px;float:left;width:150px; width:100px\9;height:18px\9;padding-right: 10px;">
							<span style="position:absolute;">DMAIC-Target Date</span>
						</div>
					</td>
				</tr>
		    	...
		    	<tr>
	       			<td valign="top">
						...
						<div>  
							<label class="mandatory-lbl"> Tangible </label>
								<input type="checkbox" name="chkKzpmIstangible" id="chkKzpmIstangible"  value="Y"  ${requestScope.Project.kzpmIstangible == 'Y' ? 'checked':''} /> Yes &nbsp&nbsp 
						<input type="checkbox" name="chkKzpmIsintangible" id="chkKzpmIsintangible"  value="Y" ${requestScope.Project.kzpmIsintangible == 'Y' ? 'checked':''} /> No 
					    
					    <input type="hidden" name="hdnKzpmIstangible" id="hdnKzpmIstangible"   />  
						<input type="hidden" name="hdnKzpmIsintangible" id="hdnKzpmIsintangible"  /> 
					...
					<span style="margin-left:0%;">
						...
						<span style="margin-left:3%;">
								<label id="lblFinalAmount">Final. Amount</label>
						</span>
						</div>
						<div>
						<span style="margin-left:0%;">	
							...
							<input class="easyui-text" id="txtKzpmVerifiedamnt" name="txtKzpmVerifiedamnt"   style="width:78px; height: 21px;"  value="${requestScope.Project.kzpmVerifiedamnt}" readonly="readonly" />
							<input class="easyui-text" id="txtKzpmFinalamnt" name="txtKzpmFinalamnt"   style="width:78px; height: 21px;"  value="${requestScope.Project.kzpmFinalamnt}" readonly="readonly" />
						</span>	
		               ...
		               <div style="padding-top:3px"><label id="lblKzpmSavings">Other Benefits</label></div>
						<div  class="easyui-paddingbfpx" >
							<textarea onkeyup="restrict(this.value,this.id)" onpaste="restrictPaste(this.value,this.id)" rows="2" cols="80" maxlength="500" style="width:255px;height:44px;" id="txtKzpmSavings" name="txtKzpmSavings" >${requestScope.Project.kzpmSavings}</textarea>	
					   ...
					   <div  class="easyui-paddingbfpx" >
							<textarea onkeyup="restrict(this.value,this.id)" onpaste="restrictPaste(this.value,this.id)" rows="4" cols="80" maxlength="900" style="width:255px;" id="txtKzpmGoalobj" name="txtKzpmGoalobj" >${requestScope.Project.kzpmGoalobj}</textarea>   
		               </div>
		 		  ...
		 		  <td style="padding-left:10px;">
					 <div style="padding-top:5px"><label> Area </label></div>
		               ...
		               <div style="padding-top:3px">   <label>Scope/Constraints</label></div>
							<div  class="easyui-paddingbfpx" >
						 	<textarea onkeyup="restrict(this.value,this.id)" onpaste="restrictPaste(this.value,this.id)" rows="4" maxlength="900" cols="80" style="width:255px;" id="txtKzpmScopeconst" name="txtKzpmScopeconst" >${requestScope.Project.kzpmScopeconst}</textarea>   
		               </div>
		 			</td>
	      			<td style="padding-left:10px;" valign="top">
					   ...
					   <div   >
	                    ...
	                    <div style="padding-top:3px">   <label id='lblKzpmBusinesscase'> Business Case</label></div>
	     						<div  >
	    						<textarea onkeyup="restrict(this.value,this.id)" onpaste="restrictPaste(this.value,this.id)" rows="4" cols="80"  maxlength="900" style="width:255px;" id="txtKzpmBusinesscase" name="txtKzpmBusinesscase" >${requestScope.Project.kzpmBusinesscase}</textarea>   
	                    </div>
	      				<div style="padding-top:3px">   
			   				 <label class="mandatory-lbl"> Created By</label>
	      				</div>
	      				<div>
	    						<input class="easyui-combobox"  style="width:255px; /* height:21px; */"  id="cmbKzpmCreatedby" readonly="readonly"  name="cmbKzpmCreatedby" value="${requestScope.Project.kzpmCreatedby}"size="15"/>   
	                    </div>
	                     <div id ="fileUpld" style="margin-left:0px; margin-top:10px;">
		      		...
		      		<td align="center" valign="top" style="padding-left: 1%;">
						...
						<div style="padding-top:10px;">
							<input type="text" id="Define" value="Define" readonly="readonly" style="border:1px solid black; font-size:15px ; width:120px;height:21px;color:black;font-weight:bold;text-align:center; " />
						</div>
						<div style="padding-top:10px;">
							<input type="text" id="Measure" value="Measure" readonly="readonly" style="border:1px solid black; font-size:15px ; width:120px;height:21px;color:black;font-weight:bold;text-align:center; " />
						</div>
						<div style="padding-top:10px;">
							<input type="text" id="Analyse" value="Analyse" readonly="readonly" style="border:1px solid black; font-size:15px ; width:120px;height:21px;color:black;font-weight:bold;text-align:center; " />			
						</div>
						<div style="padding-top:10px;">
							<input type="text" id="Improve" value="Improve" readonly="readonly" style="border:1px solid black; font-size:15px ; width:120px;height:21px;color:black;font-weight:bold;text-align:center; " />
						</div>
						<div style="padding-top:10px;">
							<input type="text" id="Control"  value="Control" readonly="readonly" style="border:1px solid black; font-size:15px ; width:120px;height:21px;color:black;font-weight:bold;text-align:center; " />
						</div>
						<div style="padding-top:10px;">
							<input type="text" id="Closure"  value="Closure" readonly="readonly" style="border:1px solid black; font-size:15px ; width:120px;height:21px;color:black;font-weight:bold;text-align:center; " />
						</div>
						</div>
						...
						<div style="padding-top:12px;">
						  ...
						  <div id ="fileUpld" style="margin-left:0px; margin-top:10px;">
						<div id="fileUpload" style="width:150px;"></div>
						<div id="err_cmbExcelName" class="tpm-errormsg" style="margin-left:20px; "></div>
					</div>			
	    			</td>
	    			
	    			<td align="left" valign="top" style="padding-left: 1%;">
				      	<div id="projectcreationTarget">				
						<div style="padding-top:10px;">
							<input name="dteKzpmDefinetargetdate" id="dteKzpmDefinetargetdate" class="easyui-datebox" value="${requestScope.Project.kzpmDefinetargetdate}" style="width:80px;width:80px;\9" />
						</div>
						<div style="padding-top:10px;">
							<input name="dteKzpmMeasuretargetdate" id="dteKzpmMeasuretargetdate" class="easyui-datebox" value="${requestScope.Project.kzpmMeasuretargetdate}" style="width:80px;width:80px;\9" />
						</div>
						<div style="padding-top:10px;">
							<input name="dteKzpmAnalysetargetdate" id="dteKzpmAnalysetargetdate" class="easyui-datebox" value="${requestScope.Project.kzpmAnalysetargetdate}" style="width:80px;width:80px;\9" />			
						</div>
						<div style="padding-top:10px;">
							<input name="dteKzpmImprovetargetdate" id="dteKzpmImprovetargetdate" class="easyui-datebox" value="${requestScope.Project.kzpmImprovetargetdate}" style="width:80px;width:80px;\9" />
						</div>
						<div style="padding-top:10px;">
							<input name="dteKzpmControltargetdate" id="dteKzpmControltargetdate" class="easyui-datebox" value="${requestScope.Project.kzpmControltargetdate}" style="width:80px;width:80px;\9" />
						</div>
						<div style="padding-top:10px;">
							<input name="dteKzpmClosuretargetdate" id="dteKzpmClosuretargetdate" class="easyui-datebox" value="${requestScope.Project.kzpmClosuretargetdate}" style="width:80px;width:80px;\9" />
						</div>
						</div>
						<!-- <div style="padding-top:12px;">
							<span  id="abnFilemgr" style="left:00%;left:00%\9;top:160px;top:165px\9;" ></span>
 ...
 -->	      	  <div style="padding-top:5px;" id="">
	...
	<input type="hidden" id="hdnEnableFinalAmnt"  name="hdnEnableFinalAmnt" value=""/>
