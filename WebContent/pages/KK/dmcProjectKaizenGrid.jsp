...
{	
	...
	{		 
		...
		//alert(filterString);dmcprojectsprotomain_input.prpo
		processGridnew("dmcprojectsprotomain_input.prpo", filterString, "projectgrid", "pager",tableCaption,"docDoubleClick","","loadProto_complete");
		return true;
	}
	return false;
}
