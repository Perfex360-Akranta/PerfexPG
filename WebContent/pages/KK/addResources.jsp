...
jQuery(document).ready(function(){
    ...
    jQuery('#btndelete').click(function(){
	 ...
	 //processGridnew("addjhmemberResourcesList_input.prpo","?q=2&role="+role+"&flid="+flid,"gridaddjhResourecesEmp","gridaddjhResourecesEmpPager");
...
function frmAddbachEmployee_FuntLocHierarchy_SuccessCallBack(result){
	...
	processGridnew("addResourcesList_input.prpo","?q=2&kzpmKeyid="+kzpmKeyid+"&flid="+result.flId,"gridResourecesEmp","gridResourecesEmpPager");

	processGridnew("addjhmemberResourcesList_input.prpo","?q=2&jhmembers=jhmembers&kzpmKeyid="+kzpmKeyid+"&flid="+result.flId,"gridaddjhResourecesEmp","gridaddjhResourecesEmpPager");
}
function frmProjectcmbaddresurceRole_onSelect(record)
{
	 ...
	 processGridnew("addjhmemberResourcesList_input.prpo","?q=2&role="+record.id+"&flid="+flid+"&saveKzpmKeyid="+hdnKzpmKeyid,"gridaddjhResourecesEmp","gridaddjhResourecesEmpPager");
}
