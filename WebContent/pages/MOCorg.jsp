	...
	// ////////////////////////////////////////////////////alert("responsibility"+responsibility);
	 ...
	 setTimeout(function() {readOnlyFields('cmbrfcmdmtid');},1250);
	   var SuggestionId=jQuery('#hdnSuggestionId').val();
		...
		formatDateBox('dteRasmDate','dd-MMM-yyyy');
...
<form id="frmMocProject">
		...
		<table>
			<tr>
				<td colspan="3" >
					...
					<input type="hidden" id="section" name="hdncmbrfcmdmtid" value="${requestScope.mocRfcmst.rfcmdmtid}"></input>
					<input type="hidden" id="cell" name="hdncmbRfcmjhid" value="${requestScope.mocRfcmst.rfcmjhid}"  ></input>
			 	...
			 	<div id="NewMocfunLocation" style="width:123%;margin-top:-5px;margin-left:-35px"></div>
			</td>
			 <td>
				 ...
				 <input type="text" class="easyui-text"  id="txtRfcmsuggestionid" name="txtRfcmsuggestionid" disabled="disabled" maxlength="10"  style=" width : 120px;height:25px; text-align:left;font-weight:bold" value="${requestScope.Kaizenbankmst.kzbnKeyid}"/>
				  ...
				  <div style="padding-left:5px;" ><label class="mandatory-lbl">Date</label></div>
				   <div style="width:350px;position:relative;padding-left:0px"> 
						      <input type="text" class="easyui-text"  id="dteRfcmdate" name="dteRfcmdate" maxlength="10"   style=" width : 100px;height:60px; text-align:left;" value="${requestScope.mocDate}"/>
						     	  </div>
				  </td>
   ...
   <div  style="margin-left:-40px;margin-top:-0px;">
	...
	<textarea maxlength="3000" rows="2" cols="80"  id="txtKzbnKaizen" name="txtKzbnKaizen" disabled="disabled" class="limit-length" style="width:818px;text-transform: uppercase; height :40px;font-weight:bold;" value="">${requestScope.Kaizenbankmst.kzbnKaizen}</textarea>	
	</div>
	</td>
	<td>
...
<div title="RequestforChange">
 ...
 <tr>
		 ...
		 <div class="easyui-paddingbfpx" style="margin-top:-5px;"><label class="mandatory-lbl">Detail</label></div>
					  <div>	
						<textarea maxlength="200"  style="width: 510px; height : 40px;text-transform: uppercase;" id="txtRfcmdetail" name="txtRfcmdetail">${requestScope.mocRfcmst.rfcmdetail}</textarea>
					</div>
		</td>
					       </tr><tr>
					       	<td>
		 <div class="easyui-paddingbfpx"style="margin-left:-0px;"><label class="mandatory-lbl">Proposed Change Description & Justification</label>
					  <div>	
						<textarea maxlength="2000"  style="width: 510px; height :50px;text-transform: uppercase;" id="txtRfcmdescription" name="txtRfcmdescription">${requestScope.mocRfcmst.rfcmdescription}</textarea>
					</div>
					</div>
		</td><td>
 		  <td>
 	  ...
 	  <div style="position:relative;margin-left:278px;margin-top:-268px;">
						     <textarea maxlength="200"  style="width: 850px; height : 30px;text-transform: uppercase;" id="txtRfcmtitle" name="txtRfcmtitle">${requestScope.mocRfcmst.rfcmtitle}</textarea>
					 </div>
...
<div class="InitialGrid">
  ...
  <div title="WhatIf">
   ...
   <td>
	...
	<textarea maxlength="3000" rows="2" cols="80"  id="txtWifmFacility" name="txtWifmFacility" class="limit-length" style="width:832px;text-transform: uppercase; height :25px;" value="">${requestScope.whatifMst.wifmFacility}</textarea>	
	</div>
   </td>
   <td>
   ...
   <td>
	...
	<div style="margin-left:-0px;">
	<textarea maxlength="3000" rows="2" cols="80"  id="txtWifmTeam" name="txtWifmTeam" class="limit-length" style="width:832px;text-transform: uppercase; height :25px;" value="">${requestScope.whatifMst.wifmTeam}</textarea>	
	</div>
   </td>
   <td>
  ...
  <table><tr>
   ...
   <td>
	...
	<div style="margin-left:-0px;">
	<textarea maxlength="3000" rows="2" cols="80"  id="txtHzomFacility" name="txtHzomFacility" class="limit-length" style="width:832px;text-transform: uppercase; height :25px;" value="">${requestScope.hazopMst.hzomFacility}</textarea>	
	</div>
   </td>
   <td>
   <div style="margin-left:30px;">
   ...
   <td>
	...
	<div style="margin-left:-0px;">
	<textarea maxlength="3000" rows="2" cols="80"  id="txtHzomTeam" name="txtHzomTeam" class="limit-length" style="width:832px;text-transform: uppercase; height :25px;" value="">${requestScope.hazopMst.hzomTeam}</textarea>	
	</div>
   </td>
   <td>
   <div style="margin-left:30px;;padding-right:0px;margin-top:5px">
   ...
   <tr>
	...
	<div style="margin-left:-0px;">
	<textarea maxlength="3000" rows="2" cols="80"  id="txtHzomNode" name="txtHzomNode" class="limit-length" style="width:550px;text-transform: uppercase; height :25px;" value="">${requestScope.hazopMst.hzomNode}</textarea>	
	</div>
   </td>
   <td>
   <div style="margin-left:-200px;">
	...
	<div style="margin-left:-0px;">
	<textarea maxlength="3000" rows="2" cols="80"  id="txtHzomDesignintent" name="txtHzomDesignintent" class="limit-length" style="width:515px;text-transform: uppercase; height :25px;" value="">${requestScope.hazopMst.hzomDesignintent}</textarea>	
	</div></div>
   </td>
   </tr>
  </table> 
...
<div class="HazopApprovalGrid">
  ...
  <tr>
   <td>
	...
	<div style="margin-left:0px;">
	<textarea maxlength="3000"  id="txtPsrmprocess" name="txtPsrmprocess"  style="width:832px;text-transform: uppercase; height :25px;" value="">${requestScope.mocPssrmst.psrmprocess}</textarea>	
	</div>
   </td>
  <td>
	...
	<div style="margin-left:0px;">
	<textarea maxlength="3000"  id="txtPsrmmocdetail" name="txtPsrmmocdetail" style="width:1125px;text-transform: uppercase; height :40px;" value="">${requestScope.mocPssrmst.psrmmocdetail}</textarea>	
	</div>
						     	  </td>
						     	  </tr>
   </table>
