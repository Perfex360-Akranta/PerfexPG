...
jQuery(document).ready(function(){
	...
	var refdoc=jQuery("#hdnrefdoctype").val();
	//alert("refdoc"+refdoc);
	if((refdoc=="KZN")||(refdoc=="ABN")||(refdoc=="PCS")||(refdoc=="INR") || (refdoc=="KPI")|| (refdoc=="CRM")|| (refdoc=="CAPA"))
		{
		
		jQuery("#btnNew").css('display','block');
	}
		else{
	...
	jQuery ("#btnNew").click(function(){
		...
		navigateToNextForm("whywhyanalysismodify_input.why?"+jQuery("#hdnFilterString").val()+"&filterButton=false",'Why Why Analysis', null, null);
	//navigateToNextForm("whywhyanalysismodify_input.why?"+jQuery("#hdnFilterString").val()+"&filterButton=false");
	});
	//viewGrid("whywhyanalysismodify_input.why","q=2&")
...
<form  name="frmWhyWhyModify" id="frmWhyWhyModify">
