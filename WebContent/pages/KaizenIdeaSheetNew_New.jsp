	  ...
	  // disableField("frmImprovementPrj","cmbKznmThemecategoryid");
{
	...
	if(Mode=="modify"||Mode=="view"){
		...
		jQuery('#maindivhght').css('height','1500');
		disableField("frmImprovementPrj","chkkznmIsworthformp");
		if(Mode=="modify"){
...
<td>
<div class="sub-header" style="width:342px;margin-top:66px;" >Idea</div>
	<div class="easyui-paddingbfpx" style="margin-top:28px;"> 
...
<div>
<input style="margin-left:429px;margin-top:10px;" id="btnswitchtoupload" class="easyui-button" name="btnswitchtoupload"  type="button" value="Switch to Kaizen Upload" style="height:30px;"/>
</div>
 <div  style="margin-left:590px;margin-top:-27px;">
