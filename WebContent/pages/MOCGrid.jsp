...
{ 
	...
	{ 
		...
		processGridnew("MocCreationGrid_input.nmoc",filterString,"MocModificationGrid","pager","","MOCDoubleClick","");
        return true;
}
 return false;	
}
...
jQuery("#btnDirectMOC").click(function()
	...
	alert("Clicked direct button sent mode == " + mode);
	   navigateToNextForm("ChangeRequest_input.nmoc?q=2&mode="+mode+"&filterButton=false","MOCCreation");
...
{	
    ...
    navigateToNextForm("ChangeRequest_input.nmoc?q=2&SuggestionFlid="+SuggestionFlid+"&WhatifKey="+WhatifKey+"&HazopKey="+HazopKey+"&Suggestion="+Suggestion+"&SuggestionId="+SuggestionId+"&Status="+Status+"&MocKeyid="+MocKeyid+"&Responsibility="+Responsibility+"&psrmkey="+psrmkey+"&filterButton=false","MOCCreation");
