...
<table style="width:100%;">
	...
	<td id="pcsViewLayer" width="70%" align="left"  style=" vertical-align:top;">
		...
		<tr>
		<td>
			<div  id="pcsFunLocnDivLayer" class="easyui-paddingbfpx" style="width:107%">
	...
	<td id="pcsEntryLayer" align="left" style="width:30%;vertical-align:top;border:1px solid #b7ceec;box-shadow: 0px 0px 4px #B6BABF;margin-left: 5px" >	
			<div style="float:left" id="showEntryLayer">
				<img src="images/layout_button_left.gif" id="showEntry" />
			</div>			
			<div style="float:left;display:none;" id="hideEntryLayer">
				<img src="images/layout_button_right.gif" id="hideEntry" />
			</div>
			<div title="Loss Entry" id="divLossEntryNew" style="width:100%;">
			...
			<div style="padding-left:8%;">
				...
				<label class="mandatory-lbl" style="padding-left:88">Cycle Time </label>
			...
			<div style="padding-left:8%;">
				...
				<label class="mandatory-lbl" style="padding-left:78">Rej Qty </label>
