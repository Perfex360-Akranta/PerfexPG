			   ...
			   */
			   ...
			   jQuery("#btnoplupload").click(function() {
				 ...
				 if(jQuery("#chkClassificationT").is(':checked')==true){
				  ...
				  ds=ds+"&opltheme="+opltheme+"&opldesc="+opldesc+"&Mode="+Mode+"&ClassificationB="+ClassificationB+"&ClassificationI="+ClassificationI+"&ClassificationT="+ClassificationT;
...
function oplmultiSelectOk_Callback(id)
{
	...
	for(var i=0;i<rowIds.length;i++)
	{
		...
		{	alert("jQuery('#'+rowIds["+i+"]).is(:checked)"+jQuery('#'+rowIds[i]).is(":checked"));
...
<span>
		...
		<div style="margin-top: 8px;"><span style="">&nbsp;</span><input
			type="checkbox" id="chkClassificationB" name="chkClassificationB"
			value="B"
			${ requestScope.oplFormBean.disableForm == true ? ' readonly':''}
			${ requestScope.oplFormBean.classificationB == 'B' ? ' checked':''} /><span
		...
		<div style="margin-top: 8px;"><span style="">&nbsp;</span><input
			...
			value="I"
			${ requestScope.oplFormBean.disableForm == true ? ' readonly':''} 
				${ requestScope.oplFormBean.classificationI == 'I' ? ' checked':''} /><span
		...
		<div style="margin-top: 8px;"><span style="">&nbsp;</span><input
			...
			value="T"
			  ${ requestScope.oplFormBean.disableForm == true ? ' readonly':''} 
			   ${ requestScope.oplFormBean.classificationT == 'T' ? ' checked':''} /><span
