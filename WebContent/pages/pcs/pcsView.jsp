...
function shift_OnError(result)
{
	...
	function CheckIsOpenMsrSuccess(result) {
		...
		//}
		//else
		//	LoadPopUp("loadPCSPopUp", "pcsPopEntry_input.pcs?"+dataStr, true,"97%","96%","1px","1px", "showPop_successCallBack","PCS Entry",false);
...
<div style="width:100% ">
	...
	<td>
		<div  class="easyui-paddingbfpx">
			...
			<div id="pcsefunLocation" style="padding-left: 1px; " ></div>
		</div>	
	</td >
	</tr>
	<tr>
	...
	<div>
		<label>Line</label>
		<label style="padding-left: 177px;" >Equipment</label>
		<label style="padding-left: 140px;padding-left: 144px\9;" >Date</label>
		<label style="padding-left: 77px;" >Shift</label>
	</div>
    <div class="easyui-paddingbfpx">
		<input type="text" id="cmbCellidSelected" name="cmbCellidSelected" class="easyui-combobox" value="${requestScope.cellId}" style="width: 190px;"/>						
		<span style="padding-left: 1%;">
	    	<input type="text" id="cmbMachineSelected" name="cmbMachineSelected" class="easyui-combobox" value="${requestScope.mchId}" style="width: 190px;"/>
	    </span>	    
...
<!--	    	<input type="button" id="btnViewPCS" name="btnViewPCS" class="easyui-button"  value="View" style=""/>-->
	    ...
	    <span style="padding-left: 1%;">
	    	<input type="button" id="btnResult" name="btnResult" class="easyui-button"  value="Result" />
	    </span>
	    <span style="padding-left: 1%;">
	    	<input type="button" id="btnRemarks" name="btnRemarks" class="easyui-button"  value="Remarks"/>
	    </span>
...
<!--		</span>		-->
	...
	<div style="" class="productionGriddDiv">			
