...
function frmKaizen_successsCallback(){
      var keyid=jQuery("#hdnKzbnKeyid").val();
	//clearForm('frmKaizen');
	//alert(result.successData.msg);
	//navigateToPrevForm();
...
<div id="wrapper" style="width:90%;">
	<div style="padding-left:15%;padding-top:0.5%;">
...
<!--          				<div class="easyui-paddingbfpx" style="border:1px solid;width:70%;padding-left:5px;">  -->
         				<input id="cmbkzbnBenefit" name="cmbkzbnBenefit" class="easyui-combobox" style="width:290px;" value="${requestScope.kaizenbank.kzbnBenefit}" ></input>
									...
									<input type="checkbox" id="chkResultAreaP" name="chkResultAreaP" onclick="chkboxCheck(this.id);" <c:out value = "${ requestScope.kaizenFormBean.disableForm == true ? ' disabled':''}"/> <c:out value = "${ requestScope.kaizenFormBean.resultAreaP == 'P' ? ' checked':''}"/>/><label style="padding-left:5px;">P</label>
									<input type="checkbox" id="chkResultAreaQ" name="chkResultAreaQ" onclick="chkboxCheck(this.id);" <c:out value = "${ requestScope.kaizenFormBean.disableForm == true ? ' disabled':''}"/> <c:out value = "${ requestScope.kaizenFormBean.resultAreaQ == 'Q' ? ' checked':''}"/>/><label style="padding-left:5px;" >Q</label>
									<input type="checkbox" id="chkResultAreaC" name="chkResultAreaC" onclick="chkboxCheck(this.id);" <c:out value = "${ requestScope.kaizenFormBean.disableForm == true ? ' disabled':''}"/> <c:out value = "${ requestScope.kaizenFormBean.resultAreaC == 'C' ? ' checked':''}"/>/><label style="padding-left:5px;">C</label>
									<input type="checkbox" id="chkResultAreaD" name="chkResultAreaD" onclick="chkboxCheck(this.id);" <c:out value = "${ requestScope.kaizenFormBean.disableForm == true ? ' disabled':''}"/> <c:out value = "${ requestScope.kaizenFormBean.resultAreaD == 'D' ? ' checked':''}"/>/><label style="padding-left:5px;">D</label>
									<input type="checkbox" id="chkResultAreaS" name="chkResultAreaS" onclick="chkboxCheck(this.id);" <c:out value = "${ requestScope.kaizenFormBean.disableForm == true ? ' disabled':''}"/> <c:out value = "${ requestScope.kaizenFormBean.resultAreaS == 'S' ? ' checked':''}"/>/><label style="padding-left:5px;">S</label>
									<input type="checkbox" id="chkResultAreaM" name="chkResultAreaM" onclick="chkboxCheck(this.id);" <c:out value = "${ requestScope.kaizenFormBean.disableForm == true ? ' disabled':''}"/> <c:out value = "${ requestScope.kaizenFormBean.resultAreaM == 'M' ? ' checked':''}"/>/><label style="padding-left:5px;">M</label>
									<input type="checkbox" id="chkResultAreaE" name="chkResultAreaE" onclick="chkboxCheck(this.id);" <c:out value = "${ requestScope.kaizenFormBean.disableForm == true ? ' disabled':''}"/> <c:out value = "${ requestScope.kaizenFormBean.resultAreaE == 'E' ? ' checked':''}"/>/><label style="padding-left:5px;">E</label>
							...
							<tr>
								<td style="padding-left:0%;"  valign="top">
									...
									<div class="easyui-paddingbfpx">
										...
										<div style="padding-left: 310px; margin-top:-27px;">
										<span class="easyui-paddingbfpx">
					                    	<textarea style="width: 350px; height : 80px;" id="txtKzbnEspNames" maxlength="490" name="txtKzbnEspNames" >${requestScope.kaizenbank.kzbnEspNames }</textarea>
					                    </span>
										...
										<span id="hsesafety" style="padding-left: 320px;margin-top:-20px;display:none;">
											<input type="checkbox" id="chkKzbnEhsrelated" name="chkKzbnEhsrelated" <c:out value = "${ requestScope.kaizenbank.kzbnEhsrelated == 'Y' ? ' checked':''}"/>/>
										    <span>
