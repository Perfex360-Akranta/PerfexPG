...
//	alert(machId+" machId "+fact +" fact " +sect +" cell "+cellId);
	...
	if(cellId== null || cellId=='' || cellId =='undefined'){
		...
		processGridnew('clitCalendar_input.cltishe','?q=2&factId='+factId+'&sectionId='+sectionId+'&cellId='+cellId +'&machId='+machId+'&flid='+flid+'&currentDate='+currentDate+'&shiftId='+shift+'',"listGrid","pager_calender","","","","jhCalLoadComplete");//,"","","","jhCalLoadComplete");
...
jQuery("#btnSave").click(function(){
  ...
  if(selArray !=null && selArray!=" " && selArray!=""){
    ...
    var activityList=jsonArr;
        ...
        processAjaxCalls("clitCalendar_save.cltishe","q=2?&actvity="+activityList+"&cellId="+cellId+"&mchineId="+mchineId+"&shiftId="+shiftId+"&status="+status+"&observation="+observation,'getCopyEquipment','getCopyEquipmentError');	
