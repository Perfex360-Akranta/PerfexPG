<script type="text/javascript">
			...
			//setLoadFormCallBackFrmId("frmabnagerpt");
			  ...
			  if( prevDataUrl == null || prevDataUrl.length <=0)		
			   ...
			   jQuery("#btnView").click(function(){
					var txtFrom = getFieldValue("txtFrom");
					var txtTo = getFieldValue("txtTo");
					//alert(txtFrom);				
					//processAjaxCalls('AbnAgeRpt_modify.abnRpt',"?&txtFrom="+txtFrom+"&txtTo="+txtTo,'abnrpt_SuccessCallBack','abnrpt_SuccessCallBack');
					processGridnew("AbnAgeRpt_modify.abnRpt","?&txtFrom="+txtFrom+"&txtTo="+txtTo, "list", "pager","","AbnAgeDoubleClick","","abnrpt_SuccessCallBack");
				});
		...
		function abnrpt_SuccessCallBack(result){
		//	alert(2);
			var fromdate = setFieldValue('txtFrom');
			var todate =setFieldValue('txtTo');
		  }
...
<label class="notes"  style="font-weight: bold; padding-left:0px;"> Double Click on Row to View Data</label>
<span style="padding-left:20px;"> 
	
						<label>Days Between From</label>
						<input type="text" name="txtFrom" id="txtFrom" class="easyui-text easyui-paddingbfpx" maxlength=10 size=4 value="" > 
						<label>And To</label>
						<input type="text" name="txtTo" id="txtTo" class="easyui-text easyui-paddingbfpx" maxlength=10 size=4 value=" " />
				        <input type="button" id="btnView" name="btnView" value="View" class="easyui-button" value=" " />
					</div>
	<div style=""> 
...
<input type="hidden" id="hdnView" name="hdnView" value="" >
</form>