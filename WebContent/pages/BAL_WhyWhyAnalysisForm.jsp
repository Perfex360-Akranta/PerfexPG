...
jQuery(document).ready(function(){
	...
	setTimeout(function() {fillComboBox("frmWhywhyAnalysis","cmbWwmsMachineid","machineCombo.commonFilter" );},1250);	
	fillComboBox("frmWhywhyAnalysis","cmbWwmsKeyid","combo_yy.why");
	formatDateBox('dteWwmsDate','dd-MMM-yyyy');
	formatDateBox('dteWwmsPrevdate','dd-MMM-yyyy');
	fillComboBox("frmWhywhyAnalysis","cmbWwmsPrevperson","employee.commonFilter");
	jQuery('#frmWhywhyAnalysis .easyui-text').css('text-transform', 'uppercase');
	jQuery('#frmWhywhyAnalysis textarea').css('text-transform', 'uppercase');
	 ...
	 setTimeout(function() {loadFunctionalLocation("wwmsfunLocation","functionalLoc.why","wwmsfunLocationValues","frmWhywhyAnalysis",dataStr);},1250);  					
	 ...
	 {	
		 if(jQuery('#hdnformType').val() == "BD")
		 {
			 ...
			 fillComboBox("frmWhywhyAnalysis","cmbWwmsAssemblyid","assembly.commonFilter");
...
jQuery( "#btnOJTSOP" ).click(function() {	
	...
	saveForm('frmWhywhyAnalysis','whywhy_save.why');
});
...
*/
function frmWhywhyAnalysiscmbWwmsMachineid_onLoadSuccess()
{
...
function frmWhywhyAnalysiscmbWwmsAssemblyid_onLoadSuccess()
{
	if(jQuery('#hdnformType').val() == "IMT")
	fillComboBox("frmWhywhyAnalysis","cmbWwmsPhenomenaid","combo_Phenomena.ire?q=2");	//fillComboBox("frmWhywhyAnalysis","cmbWwmsSectionid","sectionCombo.commonFilter");
	else
	fillComboBox("frmWhywhyAnalysis","cmbWwmsPhenomenaid","combo_phenomena.brdn?q=2");
}
function frmWhywhyAnalysiscmbWwmsPrevperson_onLoadSuccess()
{
	
}
/*function frmWhywhyAnalysiscmbWwmsSectionid_onLoadSuccess()
{
	fillComboBox("frmWhywhyAnalysis","cmbWwmsCellid","cellCombo.commonFilter");	
}
function frmWhywhyAnalysiscmbWwmsCellid_onLoadSuccess()
{
	fillComboBox("frmWhywhyAnalysis","cmbWwmsPhenomenaid","combo_phenomena.brdn");	
}*/
function frmWhywhyAnalysiscmbWwmsPhenomenaid_onLoadSuccess()
{
	if(jQuery('#hdnformType').val() == "IMT")
		fillComboBox("frmWhywhyAnalysis","cmbWwmsCauseid","combo_cause.ire");	
	else
	fillComboBox("frmWhywhyAnalysis","cmbWwmsCauseid","combo_cause.brdn");	
}
function frmWhywhyAnalysiscmbWwmsCauseid_onLoadSuccess()
{
	
	//jQuery('#cmbWwmsKeyid').combobox('disable');//fillComboBox("frmWhywhyAnalysis","cmbWwmsKeyid","combo_yy.why");	
}
function frmWhywhyAnalysiscmbWwmsKeyid_onLoadSuccess()
{
	readOnlyFields('cmbWwmsKeyid');	
	fillComboBox("frmWhywhyAnalysis","cmbWwmsMaintinchargeid","employee.commonFilter");
...
function frmWhywhyAnalysis_FuntLocHierarchy_SuccessCallBack(keyIds)
{
	...
	reloadMachine("frmWhywhyAnalysis",'cmbWwmsMachineid',keyIds.cellId,keyIds.sectId,keyIds.factId,keyIds.locnId,keyIds.compId);
	var formType = jQuery('#hdnformType').val();
	if(screen.width >=1250)
	{
		if(formType == 'SHE')
 ...
 <tr>
  ...
  <tr id="sheYYFields">
 	<td colspan="4"> 
		...
		<div class="easyui-paddingbfpx yy-body">
			<textarea rows="3" style="width: 200px;height:75px;resize:none;" cols="" id="txtWwmsAccidentdesc" name="txtWwmsAccidentdesc">${requestScope.kznWhyWhyMst.wwmsAccidentdesc}</textarea>
			<textarea rows="3" style="width: 200px;height:75px;resize:none;" cols="" id="txtWwmsAccidentphen" name="txtWwmsAccidentphen">${requestScope.kznWhyWhyMst.wwmsAccidentphen}</textarea>
			...
			<textarea rows="3" style="width: 200px;height:75px;resize:none;" cols="" id="txtWwmsPreveffective" name="txtWwmsPreveffective">${requestScope.kznWhyWhyMst.wwmsPreveffectiveness}</textarea>
		</div>
 	</td>
 </tr>
...
<!--		</div>-->
<!--		<div class="easyui-paddingbfpx" style="padding-left:30px;">-->
<!--			<textarea rows="3" style="width: 200px;resize:none;" cols="" id="txaWwmsFinalaction" name="txaWwmsFinalaction">${requestScope.kznWhyWhyMst.wwmsFinalaction}</textarea>-->
<!--		</div>-->
<!--	</td>-->
<!--	<td>-->
<!--		<div  class="easyui-paddingbfpx" style="padding-left:20px;">-->
...
<!--		</div>-->
<!--		<div class="easyui-paddingbfpx" style="padding-left:20px;">-->
<!--			<textarea rows="3" style="width: 200px;resize:none;" cols="" id="txtWwmsChecksmade" name="txtWwmsChecksmade">${requestScope.kznWhyWhyMst.wwmsChecksmade}</textarea>-->
<!--		</div>-->
<!--	</td>-->
	<td colspan="4">
	<span id="faInBD">
...
<!--			<label id="lblSustAction">Sustenance Action</label>-->
		...
		<div class="easyui-paddingbfpx yy-body">
			<textarea rows="3" style="width: 200px;margin-top:-80px\9;resize:none;" cols="" id="txaWwmsFinalaction" name="txaWwmsFinalaction">${requestScope.kznWhyWhyMst.wwmsFinalaction}</textarea>
			...
			<span>
				<textarea rows="3" style="width: 200px;resize:none;margin-right:8px;margin-top:-80px\9;" cols="" id="txtWwmsPreveffectiveness" name="txtWwmsPreveffectiveness">${requestScope.kznWhyWhyMst.wwmsPreveffectiveness}</textarea>
			</span>
...
<!--					<textarea rows="1" style="width: 200px;resize:none;margin-top:0px;" cols="" id="txtWwmsPreveffectiveness" name="txtWwmsPreveffectiveness">${requestScope.kznWhyWhyMst.wwmsPreveffectiveness}</textarea>-->
<!--				<textarea rows="3" style="width: 200px;resize:none;" cols="" id="txtWwmsCountermeasure" name="txtwwmsCountermeasure">${requestScope.kznWhyWhyMst.wwmsCountermeasure}</textarea>-->
...
<tr>
	...
	<span id="rootCauseGridinBD">
     ...
     <span id="rootCauseinKaizen">
     	...
     	<div class="easyui-paddingbfpx">
     		<textarea rows="3" style="width: 435px;height:75px;resize:none;" cols="" id="txtWwmsRootcause" name="txtWwmsRootcause">${requestScope.kznWhyWhyMst.wwmsRootcause}</textarea>
     	</div>
     </span>
         </div>
	...
	<td  valign='top' class="yy-pillarTD">
		<div  class="easyui-paddingbfpx yy-pillarDisp" style="float:left; width : 391px;">
    	    ...
    	    <span id="ActionTakenInShe" style="margin-left:3px;">
				...
				<div class="easyui-paddingbfpx">
					<textarea style="width:435px;height:75px;resize:none" name="txtWwmsCountermeasure" id="txtWwmsCountermeasure">${requestScope.kznWhyWhyMst.wwmsCountermeasure}</textarea>
				</div>		
			</span>
	...
	<td  valign='top'  class="yy-cmTD"  style="margin-left:3.3%;margin-left:-1%\9;">
	     <span id="kaizenDetailsInBD">
				...
				<div class="easyui-paddingbfpx" style="padding-top:0px;">
					<textarea style="width:200px;height:110px;resize:none" name="txtWwmsCountermeasure" id="txtWwmsCountermeasure">${requestScope.kznWhyWhyMst.wwmsCountermeasure}</textarea>
				</div>
		<!--		<div>-->
	...
	<span id="CounterMeasureInKaizen">
		...
		<div class="easyui-paddingbfpx">
			<textarea style="width:435px;height:75px;resize:none" name="txtWwmsCountermeasure" id="txtWwmsCountermeasure"></textarea>
		</div>		
	</span>
...
<!--		 <div  class="easyui-paddingbfpx">-->
<!--			<textarea rows="3" style="width: 200px;height:45px;resize:none;" cols="" id="txtWwmsCountermeasure" name="txtWwmsCountermeasure">${requestScope.kznWhyWhyMst.wwmsCountermeasure}</textarea>-->
...
<!--		  </div>-->
<!--		  <div  class="easyui-paddingbfpx">-->
<!--				<textarea rows="3" style="width: 200px;height:45px;resize:none;" cols="" id="txtWwmsPokayoke" name="txtWwmsPokayoke">${requestScope.kznWhyWhyMst.wwmsPokayoke}</textarea>-->
...
<input type="hidden" id="hdnDelYYId" name="hdnDelYYId"/>
	...
	<div id="dlgOJTSOP" class="flPopUpBox">
		...
		<div class="easyui-paddingbfpx" id="ojtRemarks" style="padding-left:10px;"> 
				<textarea id="txtWwmsOjtdesc" name="txtWwmsOjtdesc" style="width: 250px;height:100px;resize:none;"> </textarea>
		</div>
		<div class="easyui-paddingbfpx" id="sopRemarks" style="padding-left:10px;"> 
				<textarea id="txtWwmsSopdesc" name="txtWwmsSopdesc" style="width: 250px;height:100px;resize:none;"> </textarea>
		</div>
