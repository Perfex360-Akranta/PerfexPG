...
jQuery(document).ready(function(){	
	...
	//Swetha commenting the line for Simplified MOM 24 October
	//fillcurrecntshift();
...
function getMOMNwShift(record)
{
	...
	function viewGrid(url,dataString)
	{
		...
		if(dataString=="?")
			...
			processGridnew("NewMoMeetingModification_input.nmom",dataString,"list","pager","","docDoubleClick");
...
//	alert("keyid "+keyid);
	...
	var ActionPDetailId=rowData.APLD_KEYID;
	//alert(ActionPDetailId);
	var ActionPMasterId=rowData.APLD_APLM_KEYID;
	...
	ds+= '&type='+momType;
	ds+= '&ActionPDetailId='+ActionPDetailId;
	ds+='&ActionPMasterId='+ActionPMasterId;
	ds+= '&mode='+frmMode;
	ds+='&menumode=modify'
	//alert(" ds :: "+ds);
	navigateToNextForm('NewMoMeetingForm_input.nmom'+ds,momType+" Minutes Of Meeting");
