...
//	alert(rowData);
	...
	window.open("whywhyExl_view.why?keyId="+rowId);
...
jQuery('#btnSelectTab').click(function(){
	...
	if(rowid==''|| rowid==null||rowid=='undefined'){
		alert('Select Row to View Why-Why Details');
		}
	else
		OpnimpexlTemp(rowid);
...
<input type="button" id="bdbtn" onclick="" style="padding-top:3px " class="easyui-button" value="View BD"/>
<input type="button" id="btnSelectTab" onclick="" style="padding-top:3px " class="easyui-button" value="For Tab To View Why-why"/>
</div>
