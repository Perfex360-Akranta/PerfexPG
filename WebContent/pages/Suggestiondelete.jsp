...
function frmKaizenBankGrid_successsCallback(){
...
function KZBankGrid_selectRow(row){ 
	  if(jQuery('#kzbnCheckbox_'+"KZBankGrid"+'_'+row).is(':checked'))
	     ...
	     alert("The KaizenBank Id::::"+kanbankkeyid);
	     var chkhide=jQuery("#KZBankGrid").jqGrid('getCell',row,"IMPLEMENTED");
	     if(chkhide=='Yes'){
	    	 alert("The Suggestion Already Accepted");
	    	 jQuery("#jqg_KZBankGrid_"+row).attr("disabled",true);
	    	 return false;
	     }
