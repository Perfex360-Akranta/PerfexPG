...
<script type="text/javascript">
	jQuery(document).ready(function() {
		...
		setLoadFormCallBackFrmId("frmKnwwhyCumulativeReport");
		invokeAfterLoadFormCallBack();
		});
	function frmKnwwhyCumulativeReport_afterLoadCallBack(){ 
		toggleCommonFilter();
		} 
	...
	<div id="wrapperRpt" style="max-width: 1210px;">
		<table>
			<tr>
				...
				<!-- <td>
					<div style="margin-top: -28px">
						<input type="button" class="easyui-button" value="View Data"
							id="btnData" name="btnData" /><label class="notes"
					style="font-weight: bold; ">Click The Cell To View Data</label>
					</div>
				</td> -->
			</tr>
		</table>
